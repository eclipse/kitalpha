...
public final class CadenceExtensions {
  ...
  public static final String ATT_ORDER_NUMBER = "orderNumber"; ////$NON-NLS-1$
  ...
  /**
   * Method that allows to get all strategies contributing the org.polarsys.kitalpha.cgm.allocation.strategies extension point.
   * 
