...
public class ModelPluginXMLExtensionHook extends org.polarsys.kitalpha.emde.egf.PluginXMLExtensionHook {

	public ModelPluginXMLExtensionHook() {
	...
	protected void method_call_extension(final StringBuffer out, final PatternContext ctx) throws Exception {
		{
			...
			CallHelper.executeWithParameterInjection("platform:/plugin/org.polarsys.kitalpha.emde.egf/egf/eMDE_EMF_Extension.fcore#_xy4qIS93EeCJ8qG0PlPcqA", new ExecutionContext((InternalPatternContext) ctx), callParameters);
		}
