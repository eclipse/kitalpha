...
public class ItemProvidergetTextoverride
	...
	protected final String TEXT_20 = NL + "\t\treturn key + \" -> \" + value;";
	protected final String TEXT_21 = NL + "\t\t";
	protected final String TEXT_22 = " ";
	protected final String TEXT_23 = " = (";
	protected final String TEXT_24 = ")object;" + NL + "\t\t// begin-extension-code" + NL + "\t\treturn ";
	protected final String TEXT_25 = ".";
	protected final String TEXT_26 = "() + \" [\" + getString(\"_UI_";
	protected final String TEXT_27 = "_type\") + \"]\";";
	protected final String TEXT_28 = NL + "\t\t// end-extension-code";
	...
	protected final String TEXT_44 = NL + "\t\t// begin-extension-code" + NL
			+ "\t\treturn label == null || label.length() == 0 ?" + NL + "\t\t\t\"[\" + getString(\"_UI_";
	protected final String TEXT_45 = "_type\") + \"]\" : label;";
	protected final String TEXT_46 = NL + "\t\t// end-extension-code";
	protected final String TEXT_47 = NL + "\t\t// begin-extension-code" + NL + "\t\treturn \"[\" + getString(\"_UI_";
	protected final String TEXT_48 = "_type\") + \"]\";";
	protected final String TEXT_49 = NL + "\t\t// end-extension-code";
