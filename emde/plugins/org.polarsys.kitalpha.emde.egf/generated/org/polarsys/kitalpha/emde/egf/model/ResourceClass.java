...
public class ResourceClass extends org.eclipse.egf.emf.pattern.model.ResourceClass {
	...
	protected final String TEXT_21 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
	...
	protected final String TEXT_29 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	...
	protected final String TEXT_37 = "\t" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->"
	...
	protected final String TEXT_48 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	...
	protected final String TEXT_50 = NL + "\tprotected boolean useIDAttributes() {" + NL + "\t\treturn false;" + NL
			+ "\t}";
	protected final String TEXT_51 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	...
	protected final String TEXT_61 = ".OPTION_CONFIGURATION_CACHE, Boolean.TRUE);" + NL
			+ "\t\tgetDefaultSaveOptions().put(";
	protected final String TEXT_62 = ".OPTION_USE_CACHED_LOOKUP_TABLE, lookupTable);    " + NL
			+ "\t\tgetDefaultSaveOptions().put(";
	protected final String TEXT_63 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL
			+ "\t\tgetDefaultSaveOptions().put(";
	protected final String TEXT_64 = ".OPTION_SAVE_ONLY_IF_CHANGED, Resource.OPTION_SAVE_ONLY_IF_CHANGED_MEMORY_BUFFER);"
			+ NL + "\t\tgetDefaultSaveOptions().put(";
	...
	protected final String TEXT_70 = ".Literals.ANY_TYPE;" + NL + "\t\t\t}" + NL + "" + NL
	...
	protected final String TEXT_73 = ".Literals.ANY_TYPE;" + NL + "\t\t\t}" + NL + "\t\t});" + NL
			+ "\t\tgetDefaultSaveOptions().put(";
	...
	protected final String TEXT_80 = "\t\t\t\t\t\t        " + NL + "\t\t// Load Options" + NL
			+ "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_81 = ".OPTION_DEFER_ATTACHMENT, Boolean.FALSE);" + NL
			+ "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_82 = ".OPTION_DEFER_IDREF_RESOLUTION, Boolean.FALSE);" + NL
			+ "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_83 = ".OPTION_USE_DEPRECATED_METHODS, Boolean.TRUE);" + NL
			+ "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_84 = ".OPTION_USE_PARSER_POOL, parserPool);" + NL + "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_85 = ".OPTION_USE_XML_NAME_TO_FEATURE_MAP, nameToFeatureMap);" + NL
			+ "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_86 = ".OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL
			+ "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_87 = ".OPTION_RECORD_UNKNOWN_FEATURE, Boolean.TRUE);" + NL
			+ "\t\tgetDefaultLoadOptions().put(";
	protected final String TEXT_88 = ".OPTION_EXTENDED_META_DATA, Boolean.TRUE);\t\t" + NL + "\t}" + NL + "\t" + NL
			+ "\t" + NL + "\t// override to integrate the bug fix" + NL
			+ "\t// https://bugs.eclipse.org/bugs/show_bug.cgi?id=412753. The bug has been" + NL
			+ "\t// resolved in EMF 2.9.1 and 2.10" + NL + "\t";
	protected final String TEXT_89 = NL + "\t@Override" + NL + "\t";
	protected final String TEXT_90 = NL + "\tprotected void detachedHelper(";
	protected final String TEXT_91 = " eObject) {" + NL + "\t\tif (useIDs() && unloadingContents == null) {" + NL
			+ "\t\t\tif (useUUIDs()) {" + NL + "\t\t\t\tDETACHED_EOBJECT_TO_ID_MAP.put(eObject, getID(eObject));" + NL
			+ "\t\t\t}" + NL + "" + NL + "\t\t\tif (idToEObjectMap != null && eObjectToIDMap != null) {" + NL
			+ "\t\t\t\tsetID(eObject, null);" + NL + "\t\t\t}" + NL + "\t\t}" + NL
			+ "\t\tresourceImplDetachedHelper(eObject);" + NL + "\t}" + NL + "\t" + NL + "\t// Duplicated from" + NL
			+ "\t// org.eclipse.emf.ecore.resource.impl.ResourceImpl.detachedHelper(EObject)" + NL
			+ "\tprivate void resourceImplDetachedHelper(";
	protected final String TEXT_92 = " eObject) {" + NL + "\t\tMap<String, EObject> map = getIntrinsicIDToEObjectMap();"
			+ NL + "\t\tif (map != null) {" + NL + "\t\t\tString id = ";
	protected final String TEXT_93 = ".getID(eObject);" + NL + "\t\t\tif (id != null) {" + NL
			+ "\t\t\t\tmap.remove(id);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL
			+ "\t\tif (isTrackingModification()) {" + NL
			+ "\t\t\teObject.eAdapters().remove(modificationTrackingAdapter);" + NL + "\t\t}" + NL + "\t}" + NL + "\t"
			+ NL;
	...
	protected final String TEXT_95 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_96 = NL + "\t@Override";
	protected final String TEXT_97 = NL + "\tpublic void doLoad(InputStream inputStream, ";
	protected final String TEXT_98 = " options) throws IOException" + NL + "\t{" + NL
	...
	protected final String TEXT_100 = ")options.get(XMLResource.OPTION_PARSER_PROPERTIES), " + NL
	...
	protected final String TEXT_103 = " options) throws IOException" + NL + "\t{" + NL
			+ "\t\tif (options != null && Boolean.TRUE.equals(options.get(OPTION_USE_DATA_CONVERTER)))" + NL + "\t\t{"
	...
	protected final String TEXT_105 = ")options.get(XMLResource.OPTION_PARSER_PROPERTIES), " + NL
			+ "\t\t\t\t  Boolean.TRUE.equals(options.get(XMLResource.OPTION_USE_LEXICAL_HANDLER))).eContainer());" + NL
	...
	protected final String TEXT_110 = " " + NL + "\t\tif (features != null)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_113 = ";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tSAXParser saxParser = null;" + NL
			+ "\t\ttry" + NL + "\t\t{" + NL
	...
	protected final String TEXT_116 = NL + "\t\t}" + NL + "\t\tcatch (Exception exception)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_124 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL
	...
	protected final String TEXT_136 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL
			+ "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\tpublic ";
	...
	protected final String TEXT_147 = "Value;" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL
			+ "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\tpublic static class ";
	protected final String TEXT_148 = "StackFrame extends ";
	protected final String TEXT_149 = NL + "\t\t{" + NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL
			+ "\t\t\tprotected ";
	...
	protected final String TEXT_156 = NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL
			+ "\t\t\tprotected ";
	protected final String TEXT_157 = " ";
	protected final String TEXT_158 = ";" + NL + "\t\t";
	protected final String TEXT_159 = NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */";
	...
	protected final String TEXT_185 = " startElement(String namespace, String localName, String qName, Attributes attributes) throws SAXException"
			+ NL + "\t\t\t{";
	...
	protected final String TEXT_195 = NL + "\t\t\t\telse" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\treturn super.startElement(namespace, localName, qName, attributes);" + NL + "\t\t\t\t}";
	protected final String TEXT_196 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t/**" + NL
			+ "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
			+ NL + "\t\t\t */";
	...
	protected final String TEXT_219 = NL + "\t\t\t\telse" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tsuper.endElement(child);"
			+ NL + "\t\t\t\t}";
	protected final String TEXT_220 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t/**" + NL
			+ "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
			+ NL + "\t\t\t */";
	...
	protected final String TEXT_225 = "();" + NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t\t/**" + NL
			+ "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
			+ NL + "\t\t\t */" + NL + "\t\t\tprotected ";
	...
	protected final String TEXT_233 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic ";
	...
	protected final String TEXT_245 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL
			+ "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\tpublic ";
		...
		if (genPackage.getResource() == GenResourceKind.XML_LITERAL
			...
			if (genPackage.isExtensibleProviderFactory() || genPackage.isChildCreationExtenders()) {
				...
				if (genPackage.getResource() == GenResourceKind.XML_LITERAL) {
					...
					stringBuffer
							.append(genModel.getImportedName("org.polarsys.kitalpha.emde.xmi.XMLExtensionSaveImpl"));
					stringBuffer.append(TEXT_26);
				} else {
					stringBuffer.append(TEXT_27);
					stringBuffer
							.append(genModel.getImportedName("org.polarsys.kitalpha.emde.xmi.XMIExtensionSaveImpl"));
