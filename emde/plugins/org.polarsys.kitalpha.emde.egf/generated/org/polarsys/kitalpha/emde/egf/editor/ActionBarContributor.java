...
public class ActionBarContributor extends org.eclipse.egf.emf.pattern.editor.ActionBarContributor {
	...
	protected final String TEXT_19 = ".loadResourceForCurrentResourceSet(selection, modelToLoad);" + NL
			...
			+ NL + "\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\tComponentSampleEditorPlugin.INSTANCE.log(e);"
			+ NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL
	...
	protected final String TEXT_24 = NL + "\t\tpublic boolean isEnabled() {" + NL
	...
	protected final String TEXT_30 = ") activeEditorPart)" + NL + "\t\t\t\t\t\t.getViewer();" + NL
	...
	protected final String TEXT_35 = NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL
	...
	protected final String TEXT_42 = NL + "\t/**" + NL + "\t * ExtendedLoadResourceAction." + NL
	...
	protected final String TEXT_45 = NL + "\t\tpublic void run() {" + NL
			+ "\t\t\tExtendedLoadResourceDialog loadResourceDialog = new ExtendedLoadResourceDialog(" + NL + "\t\t\t\t";
	protected final String TEXT_46 = ".getWorkbench().getActiveWorkbenchWindow().getShell(), domain" + NL
	...
	protected final String TEXT_48 = " parent, EditingDomain domain) {" + NL + "\t\t\t\tsuper(parent, domain);" + NL
	...
	protected final String TEXT_52 = ".add(resourceSet, resourceSet.getResources().get(0).getURI(), resource.getURI());"
	...
	protected final String TEXT_59 = ".INSTANCE.getString(\"_UI_SelectRegisteredPackageURI\"));";
