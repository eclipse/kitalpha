...
public class ActionBarContributor extends org.eclipse.egf.emf.pattern.editor.ActionBarContributor {
	...
	protected final String TEXT_16 = NL + "\t\tpublic boolean isEnabled() {" + NL + "\t\t\treturn activeEditorPart instanceof ";
	...
	protected final String TEXT_22 = ") activeEditorPart)" + NL + "\t\t\t\t\t\t.getViewer();" + NL + "\t\t\t\tif (viewer != null) {" + NL + "\t\t\t\t\tviewer.refresh();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\tprivate final class ShowPropertiesViewAction extends ";
	...
	protected final String TEXT_27 = NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tgetPage().showView(\"org.eclipse.ui.views.PropertySheet\"); ";
	...
	protected final String TEXT_31 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static final String copyright = ";
	protected final String TEXT_32 = ";";
	protected final String TEXT_33 = NL;
	protected final String TEXT_34 = NL + "\t/**" + NL + "\t * ExtendedLoadResourceAction." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class ExtendedLoadResourceAction extends ";
	...
	protected final String TEXT_37 = NL + "\t\tpublic void run() {" + NL + "\t\t\tExtendedLoadResourceDialog loadResourceDialog = new ExtendedLoadResourceDialog(" + NL + "\t\t\t\t";
	protected final String TEXT_38 = ".getWorkbench().getActiveWorkbenchWindow().getShell(), domain" + NL + "\t\t\t);    " + NL + "\t\t\tloadResourceDialog.open();" + NL + "\t\t} " + NL + "\t\t   " + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t \t * <!-- end-user-doc -->" + NL + "\t \t * @generated" + NL + "\t \t */    " + NL + "\t\tpublic static class ExtendedLoadResourceDialog extends ";
	protected final String TEXT_39 = " {" + NL + "\t\t\t/**" + NL + "\t \t\t * <!-- begin-user-doc -->" + NL + "\t \t\t * <!-- end-user-doc -->" + NL + "\t \t\t * @generated" + NL + "\t \t\t */\t\t\t\t" + NL + "\t\t\tpublic ExtendedLoadResourceDialog(";
	protected final String TEXT_40 = " parent, EditingDomain domain) {" + NL + "\t\t\t\tsuper(parent, domain);" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t/**" + NL + "\t \t\t * <!-- begin-user-doc -->" + NL + "\t \t\t * <!-- end-user-doc -->" + NL + "\t \t\t * @generated" + NL + "\t \t\t */";
	...
	protected final String TEXT_44 = " parent) {" + NL + "\t\t\t\tComposite composite = (Composite)super.createDialogArea(parent);" + NL + "\t\t\t\tComposite buttonComposite = (Composite)composite.getChildren()[0];" + NL + "\t\t\t\t";
	...
	protected final String TEXT_54 = " event) {" + NL + "\t\t\t\t\t\t\tRegisteredPackageDialog registeredPackageDialog = new RegisteredPackageDialog(getShell());" + NL + "\t\t\t\t\t\t\tregisteredPackageDialog.open();" + NL + "\t\t\t\t\t\t\tObject [] result = registeredPackageDialog.getResult();" + NL + "\t\t\t\t\t\t\tif (result != null) {" + NL + "\t\t\t\t\t\t\t\t";
	protected final String TEXT_55 = "<?> nsURIs = Arrays.asList(result);" + NL + "\t\t\t\t\t\t\t\t";
	protected final String TEXT_56 = " resourceSet = new ";
	protected final String TEXT_57 = "();" + NL + "\t\t\t\t\t\t\t\tresourceSet.getURIConverter().getURIMap().putAll(EcorePlugin.computePlatformURIMap());" + NL + "\t\t\t\t\t\t\t\tStringBuffer uris = new StringBuffer();" + NL + "\t\t\t\t\t\t\t\tMap<String, URI> ePackageNsURItoGenModelLocationMap = EcorePlugin.getEPackageNsURIToGenModelLocationMap();" + NL + "\t\t\t\t\t\t\t\tfor (int i = 0, length = result.length; i < length; i++) {" + NL + "\t\t\t\t\t\t\t\t\tURI location = ePackageNsURItoGenModelLocationMap.get(result[i]);" + NL + "\t\t\t\t\t\t\t\t\t";
	protected final String TEXT_58 = " resource = resourceSet.getResource(location, true);" + NL + "\t\t\t\t\t\t\t\t\t";
	protected final String TEXT_59 = ".resolveAll(resource);" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\tfor (Resource resource : resourceSet.getResources()) {" + NL + "\t\t\t\t\t\t\t\t\tfor (";
	protected final String TEXT_60 = "<?> j = " + NL + "\t\t\t\t\t\t\t\t\t\tnew EcoreUtil.ContentTreeIterator<Object>(resource.getContents()) {" + NL + "\t\t\t\t\t\t\t\t\t\t\tprivate static final long serialVersionUID = 1L;\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t@Override" + NL + "\t\t\t\t\t\t\t\t\t\t\tprotected ";
	protected final String TEXT_61 = "<? extends ";
	protected final String TEXT_62 = "> getEObjectChildren(EObject eObject) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\treturn " + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\teObject instanceof ";
	protected final String TEXT_63 = " ? " + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t((EPackage)eObject).getESubpackages().iterator() : " + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t";
	protected final String TEXT_64 = ".<EObject>emptyList().iterator();" + NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t};" + NL + "\t\t\t\t\t\t\t\t\t\tj.hasNext();) {" + NL + "\t\t\t\t\t\t\t\t\t\t\tObject content = j.next();" + NL + "\t\t\t\t\t\t\t\t\t\t\tif (content instanceof EPackage) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tEPackage ePackage = (EPackage)content;" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif (nsURIs.contains(ePackage.getNsURI())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\turis.append(resource.getURI());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\turis.append(\"  \");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\turiField.setText((uriField.getText() + \"  \" + uris.toString()).trim());" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t);      " + NL + "\t\t\t}" + NL + "\t\t}" + NL + "    " + NL + "\t\t/**" + NL
			+ "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */    " + NL + "\t\tpublic static class RegisteredPackageDialog extends ";
	protected final String TEXT_65 = " {" + NL + "\t\t\t/**" + NL + "\t \t\t * <!-- begin-user-doc -->" + NL + "\t \t\t * <!-- end-user-doc -->" + NL + "\t \t\t * @generated" + NL + "\t \t\t */\t\t\t\t\t\t\t\t" + NL + "\t\t\tpublic RegisteredPackageDialog(Shell parent) {" + NL + "\t\t\t\tsuper(" + NL + "\t\t\t\t\tparent, " + NL + "\t\t\t\t\tnew ";
	...
	protected final String TEXT_70 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t);        " + NL + "\t\t\t\tsetMultipleSelection(true);" + NL + "\t\t\t\tsetMessage(EcoreEditorPlugin.INSTANCE.getString(\"_UI_SelectRegisteredPackageURI\"));";
	...
	protected final String TEXT_74 = ".getEPackageNsURIToGenModelLocationMap();" + NL + "\t\t\t\tObject [] result = ePackageNsURItoGenModelLocationMap.keySet().toArray(new Object[ePackageNsURItoGenModelLocationMap.size()]);" + NL + "\t\t\t\t";
	protected final String TEXT_75 = ".sort(result);" + NL + "\t\t\t\tsetElements(result);" + NL + "\t\t\t\tsetTitle(EcoreEditorPlugin.INSTANCE.getString(\"_UI_PackageSelection_label\"));";
	protected final String TEXT_76 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "    " + NL + "\t}" + NL;
	protected final String TEXT_77 = NL + "\t/**" + NL + "\t * Action to create objects from the ";
	protected final String TEXT_78 = " model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class NewAction extends ";
	protected final String TEXT_79 = NL + "\t{" + NL + "\t\t/**" + NL + "\t\t * @see org.eclipse.ui.IActionDelegate#run(org.eclipse.jface.action.IAction)" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic void run(";
	...
	protected final String TEXT_85 = "(getWindow().getShell(), wizard);" + NL + "\t\t\twizardDialog.open();" + NL + "\t\t}" + NL + "\t}" + NL;
	protected final String TEXT_86 = NL + "\t/**" + NL + "\t * This keeps track of the active editor." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_87 = " activeEditorPart;" + NL + "" + NL + "\t/**" + NL + "\t * This keeps track of the current selection provider." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_88 = " selectionProvider;" + NL + "" + NL + "\t/**" + NL + "\t * This action opens the Properties view." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_89 = " showPropertiesViewAction = new ShowPropertiesViewAction();" + NL + "\t" + NL + "\t/**" + NL + "\t * This action refreshes the viewer of the current editor if the editor" + NL + "\t * implements {@link org.eclipse.emf.common.ui.viewer.IViewerProvider}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
