...
public class ActionBarContributor extends org.eclipse.egf.emf.pattern.editor.ActionBarContributor {
	...
	protected final String TEXT_64 = ".<EObject>emptyList().iterator();" + NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t};" + NL + "\t\t\t\t\t\t\t\t\t\tj.hasNext();) {" + NL + "\t\t\t\t\t\t\t\t\t\t\tObject content = j.next();" + NL + "\t\t\t\t\t\t\t\t\t\t\tif (content instanceof EPackage) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tEPackage ePackage = (EPackage)content;" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif (nsURIs.contains(ePackage.getNsURI())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\turis.append(resource.getURI());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\turis.append(\"  \");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t}" + NL
