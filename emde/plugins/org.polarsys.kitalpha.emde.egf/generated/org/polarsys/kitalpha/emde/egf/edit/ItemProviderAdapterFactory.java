...
public class ItemProviderAdapterFactory extends org.eclipse.egf.emf.pattern.edit.ItemProviderAdapterFactory {
	...
	protected final String TEXT_112 = " object)" + NL + "\t\t\t{" + NL + "\t\t\t\t// begin-extension-code" + NL
			+ "\t\t\t\tif (";
	...
	protected final String TEXT_116 = NL + "\t\t\t\t\treturn null;\t\t\t\t" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t\t// end-extension-code";
	...
	protected final String TEXT_123 = NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL
			+ "\t\t\tprotected ";
	protected final String TEXT_124 = " createChildParameter(Object feature, Object child)" + NL + "\t\t\t{" + NL
			+ "\t\t\t\treturn new ";
	protected final String TEXT_125 = "(null, feature, child);" + NL + "\t\t\t}" + NL + "" + NL + "\t\t}" + NL + "" + NL
	...
	protected final String TEXT_130 = ")object);" + NL + "\t\t   return result;" + NL + "\t\t}" + NL + "" + NL
			+ "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL
			+ "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic ";
