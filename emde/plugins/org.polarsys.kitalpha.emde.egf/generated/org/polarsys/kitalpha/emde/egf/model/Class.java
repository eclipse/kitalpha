...
public class Class extends org.eclipse.egf.emf.pattern.model.Class {
	...
	protected final String TEXT_273 = NL + "\t\tsuper.eSet(featureID, newValue);";
	protected final String TEXT_274 = NL + "\t\teDynamicSet(featureID, newValue);";
	...
	protected final String TEXT_283 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID";
	...
	protected final String TEXT_294 = NL + "\t\tif (baseClass == ";
	protected final String TEXT_295 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
	protected final String TEXT_296 = NL + "\t\t\t\tcase ";
	protected final String TEXT_297 = ": return ";
	protected final String TEXT_298 = ";";
	protected final String TEXT_299 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
	protected final String TEXT_300 = NL + "\t\tif (baseClass == ";
	protected final String TEXT_301 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID";
	...
	protected final String TEXT_313 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID)" + NL + "\t\t\t{";
	...
	protected final String TEXT_324 = NL + "\t\tif (baseClass == ";
	protected final String TEXT_325 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseOperationID";
	protected final String TEXT_326 = ")" + NL + "\t\t\t{";
	protected final String TEXT_327 = NL + "\t\t\t\tcase ";
	...
	protected final String TEXT_356 = " arguments) throws ";
	protected final String TEXT_357 = NL + "\t{" + NL + "\t\tswitch (operationID";
	protected final String TEXT_358 = ")" + NL + "\t\t{";
	protected final String TEXT_359 = NL + "\t\t\tcase ";
	...
	protected final String TEXT_366 = "arguments.get(";
	protected final String TEXT_367 = ")";
	protected final String TEXT_368 = ").";
	protected final String TEXT_369 = "()";
	protected final String TEXT_370 = ", ";
	protected final String TEXT_371 = ");" + NL + "\t\t\t\treturn null;";
	...
	protected final String TEXT_379 = "arguments.get(";
	...
	protected final String TEXT_398 = NL + "\t\tif (eVirtualIsSet(";
	protected final String TEXT_399 = ")) result.append(eVirtualGet(";
	protected final String TEXT_400 = ")); else result.append(\"<unset>\");";
	protected final String TEXT_401 = NL + "\t\tif (";
	protected final String TEXT_402 = "(";
	protected final String TEXT_403 = " & ";
	protected final String TEXT_404 = "_ESETFLAG) != 0";
	protected final String TEXT_405 = "ESet";
	protected final String TEXT_406 = ") result.append((";
	protected final String TEXT_407 = " & ";
	protected final String TEXT_408 = "_EFLAG) != 0); else result.append(\"<unset>\");";
	protected final String TEXT_409 = NL + "\t\tif (";
	protected final String TEXT_410 = "(";
	protected final String TEXT_411 = " & ";
	protected final String TEXT_412 = "_ESETFLAG) != 0";
	protected final String TEXT_413 = "ESet";
	protected final String TEXT_414 = ") result.append(";
	protected final String TEXT_415 = "_EFLAG_VALUES[(";
	protected final String TEXT_416 = " & ";
	protected final String TEXT_417 = "_EFLAG) >>> ";
	protected final String TEXT_418 = "_EFLAG_OFFSET]); else result.append(\"<unset>\");";
	protected final String TEXT_419 = NL + "\t\tif (";
	protected final String TEXT_420 = "(";
	protected final String TEXT_421 = " & ";
	protected final String TEXT_422 = "_ESETFLAG) != 0";
	protected final String TEXT_423 = "ESet";
	protected final String TEXT_424 = ") result.append(";
	protected final String TEXT_425 = "); else result.append(\"<unset>\");";
	protected final String TEXT_426 = NL + "\t\tresult.append(eVirtualGet(";
	protected final String TEXT_427 = ", ";
	protected final String TEXT_428 = "));";
	protected final String TEXT_429 = NL + "\t\tresult.append((";
	protected final String TEXT_430 = " & ";
	protected final String TEXT_431 = "_EFLAG) != 0);";
	protected final String TEXT_432 = NL + "\t\tresult.append(";
	protected final String TEXT_433 = "_EFLAG_VALUES[(";
	protected final String TEXT_434 = " & ";
	protected final String TEXT_435 = "_EFLAG) >>> ";
	...
	protected final String TEXT_454 = NL + "\t\tsetTypedKey(key);";
	...
	protected final String TEXT_469 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll(";
	protected final String TEXT_470 = "(";
	protected final String TEXT_471 = ")";
	protected final String TEXT_472 = "value);";
	protected final String TEXT_473 = NL + "\t\tsetTypedValue(value);";
	...
	protected final String TEXT_483 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
	protected final String TEXT_484 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
