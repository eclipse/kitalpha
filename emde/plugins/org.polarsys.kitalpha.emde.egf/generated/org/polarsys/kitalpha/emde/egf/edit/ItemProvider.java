...
public class ItemProvider extends org.eclipse.egf.emf.pattern.edit.ItemProvider {
  ...
  protected final String TEXT_24 = NL + "\t/**" + NL + "\t * This constructs an instance from a factory and a notifier."
  ...
  protected final String TEXT_49 = NL + "\t/**" + NL
      + "\t * This returns the property descriptors for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_85 = NL + "\t/**" + NL + "\t * This returns the label styled text for the adapted class."
      + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
    ...
    if ((genPackage.isExtensibleProviderFactory() || genPackage.isChildCreationExtenders())
      ...
      stringBuffer
          .append(genModel.getImportedName("org.polarsys.kitalpha.emde.extension.edit.ExtensionItemProviderAdapter"));
    } else {
      stringBuffer.append(TEXT_12);
