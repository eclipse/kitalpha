...
public class Editor extends org.eclipse.egf.emf.pattern.editor.Editor {
	...
	protected final String TEXT_181 = NL + "\t\tException exception = null;" + NL + "\t\tResource resource = null;" + NL
			...
			+ "\t\t";
	protected final String TEXT_182 = ".getViewpointMetadata(editingDomain.getResourceSet()).initMetadataStorage();"
			+ NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_187 = NL + "\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t getString(\"_UI_CreateModelError_message\", resource.getURI()),";
	protected final String TEXT_188 = NL + "\t\t\t\t\t new Object[] { exception });" + NL + "\t\t}" + NL + "\t\telse"
	...
	protected final String TEXT_190 = NL + "\tpublic void createPages()" + NL + "\t{" + NL
	...
	protected final String TEXT_219 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// This is the page for the list viewer"
			+ NL + "\t\t\t//" + NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	...
	protected final String TEXT_233 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// This is the page for the tree viewer"
			+ NL + "\t\t\t//" + NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	...
	protected final String TEXT_288 = "));" + NL + "\t\t\tselectionViewer.setInput(editingDomain.getResourceSet());"
			+ NL
			+ "\t\t\tselectionViewer.setSelection(new StructuredSelection(editingDomain.getResourceSet().getResources().get(0)), true);"
	...
	protected final String TEXT_308 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			...
			+ "\t\t\t\t\t}  ";
	protected final String TEXT_309 = "\t\t\t\t\t\t\t\t\t\t" + NL + "" + NL + "\t\t\t\t\t// Set up the tree viewer."
			+ NL + "\t\t\t\t\t//" + NL
	...
	protected final String TEXT_329 = NL + "\t\t\t\t\tpublic void setActionBars(IActionBars actionBars)" + NL
			+ "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tsuper.setActionBars(actionBars);" + NL
			+ "\t\t\t\t\t\tgetActionBarContributor().shareGlobalActions(this, actionBars);" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t};" + NL
	...
	protected final String TEXT_334 = " selectedElements = ((IStructuredSelection)selection).iterator();" + NL
	...
	protected final String TEXT_341 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_343 = NL + "\tpublic boolean isDirty()" + NL + "\t{" + NL
	...
	protected final String TEXT_345 = NL + "\tpublic void doSave(IProgressMonitor progressMonitor)" + NL + "\t{" + NL
	...
	protected final String TEXT_354 = "(IProgressMonitor monitor)" + NL + "\t\t\t\t{" + NL
	...
	protected final String TEXT_359 = NL
			...
			+ NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\ttry" + NL + "\t\t\t\t\t\t\t{";
	protected final String TEXT_360 = NL + "\t\t\t\t\t\t\t\tlong timeStamp = resource.getTimeStamp();" + NL
			+ "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
			+ "\t\t\t\t\t\t\t\tif (resource.getTimeStamp() != timeStamp)" + NL + "\t\t\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\t\t\tsavedResources.add(resource);" + NL + "\t\t\t\t\t\t\t\t}";
	protected final String TEXT_361 = NL + "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
			+ "\t\t\t\t\t\t\t\tsavedResources.add(resource);";
	protected final String TEXT_362 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcatch (Exception exception)" + NL
			+ "\t\t\t\t\t\t\t{" + NL
			...
			+ NL + "\t\t\t//" + NL + "\t\t\t";
	protected final String TEXT_363 = ".INSTANCE.log(exception);" + NL + "\t\t}" + NL
	...
	protected final String TEXT_365 = NL + "\tpublic boolean isSaveAsAllowed()" + NL + "\t{" + NL + "\t\treturn true;"
	...
	protected final String TEXT_371 = NL + "\t\t\t\tprotected boolean isSave()" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\treturn true;" + NL + "\t\t\t\t}" + NL;
	protected final String TEXT_372 = NL + "\t\t\t\t@Override";
	protected final String TEXT_373 = NL + "\t\t\t\tprotected boolean processResources()" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\t";
	protected final String TEXT_374 = " uris = getURIs();" + NL + "\t\t\t\t\tif (uris.size() > 0)" + NL + "\t\t\t\t\t{"
			+ NL + "\t\t\t\t\t\tURI uri = ";
	protected final String TEXT_375 = "uris.get(0);" + NL + "\t\t\t\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_376 = "(uri));" + NL + "\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t\telse" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}.open();";
	protected final String TEXT_377 = NL + "\t\tString[] filters = ";
	protected final String TEXT_378 = "(String[])";
	protected final String TEXT_379 = "FILE_EXTENSION_FILTERS.toArray(new String[FILE_EXTENSION_FILTERS.size()]);" + NL
			+ "\t\tString[] files = ";
	protected final String TEXT_380 = ".openFilePathDialog(getSite().getShell(), ";
	protected final String TEXT_381 = ".SAVE, filters);" + NL + "\t\tif (files.length > 0)" + NL + "\t\t{" + NL
			+ "\t\t\tURI uri = URI.createFileURI(files[0]);" + NL + "\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_382 = "(uri));" + NL + "\t\t}";
	protected final String TEXT_383 = NL + "\t\tSaveAsDialog saveAsDialog = new SaveAsDialog(getSite().getShell());"
			...
			+ NL + "\t\t\t}" + NL + "\t\t}";
	protected final String TEXT_384 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
			+ "\tprotected void doSaveAs(URI uri, IEditorInput editorInput)" + NL + "\t{" + NL + "\t\t(";
	protected final String TEXT_385 = "(Resource)";
	protected final String TEXT_386 = "editingDomain.getResourceSet().getResources().get(0)).setURI(uri);" + NL
	...
	protected final String TEXT_388 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
	...
	protected final String TEXT_390 = NL + NL + "\t/**" + NL + "\t * This is called during startup." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_391 = NL + "\t@Override";
	protected final String TEXT_392 = NL + "\tpublic void init(IEditorSite site, IEditorInput editorInput)" + NL + "\t{"
	...
	protected final String TEXT_394 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_395 = NL + "\t@Override";
	protected final String TEXT_396 = NL + "\tpublic void setFocus()" + NL + "\t{";
	protected final String TEXT_397 = NL + "\t\tif (currentViewerPane != null)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_405 = " collection = ((IStructuredSelection)selection).toList();" + NL
			+ "\t\t\t\tswitch (collection.size())" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tcase 0:" + NL + "\t\t\t\t\t{"
			+ NL + "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_NoObjectSelected\"));";
	protected final String TEXT_406 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tcase 1:" + NL
			+ "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tString text = new AdapterFactoryItemDelegator(adapterFactory).getText(collection.iterator().next());"
			+ NL + "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_SingleObjectSelected\", text));";
	protected final String TEXT_407 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tdefault:" + NL
			+ "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_MultiObjectSelected\", Integer.toString(collection.size())));";
	protected final String TEXT_408 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}"
	...
	protected final String TEXT_410 = ".INSTANCE.getString(key);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_411 = ".INSTANCE.getString(key, new Object [] { s1 });" + NL + "\t}" + NL + "" + NL
			+ "\t/**" + NL
	...
	protected final String TEXT_413 = NL + "\tpublic void dispose()" + NL + "\t{" + NL
	...
	protected final String TEXT_415 = NL + "\t\tgetSite().getPage().removePartListener(partListener);" + NL + "" + NL
	...
	protected final String TEXT_418 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			+ "\t\t\t\tfilterAction.removePropertyChangeListener((";
	protected final String TEXT_419 = ") getActionBarContributor());" + NL + "\t\t\t\tfilterAction.dispose();" + NL
