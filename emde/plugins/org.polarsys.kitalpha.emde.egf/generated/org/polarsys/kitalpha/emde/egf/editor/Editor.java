...
public class Editor extends org.eclipse.egf.emf.pattern.editor.Editor {
	...
	protected final String TEXT_85 = ".this);" + NL + "" + NL + "\t\t\t\t\t\tsetCurrentViewer(contentOutlineViewer);"
	...
	protected final String TEXT_158 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This creates a model editor."
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_159 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t\tinitializeEditingDomain();"
	...
	protected final String TEXT_207 = "(getResource())).toList());" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL
			+ "\t\t\t\t\t\t\t\t\t\tsetSelectionToViewer((new ";
	protected final String TEXT_208 = "(getResource().getContents().get(0))).toList());" + NL + "\t\t\t\t\t\t\t\t\t}"
			+ NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t};\t\t\t" + NL
	...
	protected final String TEXT_222 = NL + "\t\tException exception = null;" + NL + "\t\tResource resource = null;" + NL
			...
			+ "\t\t";
	protected final String TEXT_223 = ".getViewpointMetadata(editingDomain.getResourceSet()).initMetadataStorage();"
			+ NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_225 = NL
			...
			+ "\t\t\t\t\t \"";
	protected final String TEXT_226 = NL + "\t\t\t\t\t new Object[] { exception });" + NL + "\t\t}" + NL + "\t\telse"
	...
	protected final String TEXT_247 = ");" + NL + "\t\t\t\tselectionViewer.setInput(editingDomain.getResourceSet());"
			+ NL
	...
	protected final String TEXT_259 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// This is the page for the list viewer"
			+ NL + "\t\t\t//" + NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	...
	protected final String TEXT_269 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// This is the page for the tree viewer"
			+ NL + "\t\t\t//" + NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	...
	protected final String TEXT_345 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			...
			+ "\t\t\t\t\t}  ";
	protected final String TEXT_346 = "\t\t\t\t\t\t\t\t\t\t" + NL + "" + NL + "\t\t\t\t\t// Set up the tree viewer."
			+ NL + "\t\t\t\t\t//" + NL + "\t\t\t\t\tcontentOutlineViewer.setUseHashlookup(true);" + NL
	...
	protected final String TEXT_369 = NL + "\t\t\t\tpublic void setActionBars(IActionBars actionBars)" + NL
			+ "\t\t\t\t{" + NL + "\t\t\t\t\tsuper.setActionBars(actionBars);" + NL
			+ "\t\t\t\t\tgetActionBarContributor().shareGlobalActions(this, actionBars);" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t};" + NL
	...
	protected final String TEXT_374 = " selectedElements = ((IStructuredSelection)selection).iterator();" + NL
	...
	protected final String TEXT_377 = "();" + NL + "\t\t\t\t\tselectionList.add(selectedElement);" + NL
	...
	protected final String TEXT_379 = "();" + NL + "\t\t\t\tselectionList.add(selectedElement);" + NL
			+ "\t\t\t\twhile (selectedElements.hasNext())" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\tselectionList.add(selectedElements.next());" + NL + "\t\t\t\t}" + NL + "" + NL
			+ "\t\t\t\t// Set the selection to the widget." + NL + "\t\t\t\t//" + NL
			+ "\t\t\t\tselectionViewer.setSelection(new StructuredSelection(selectionList));";
	protected final String TEXT_380 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * This is for implementing {@link IEditorPart} and simply tests the command stack." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_381 = NL + "\tpublic boolean isDirty()" + NL + "\t{" + NL
			+ "\t\treturn ((BasicCommandStack)editingDomain.getCommandStack()).isSaveNeeded();" + NL + "\t}" + NL;
	protected final String TEXT_382 = NL + "\t/**" + NL + "\t * This is for implementing {@link IRevertablePart}." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_388 = "();" + NL + "\t\tupdateProblemIndication = false;" + NL
	...
	protected final String TEXT_392 = NL + "\t\t\ttry" + NL + "\t\t\t{" + NL
			+ "\t\t\t\tresource.load(resourceSet.getLoadOptions());" + NL + "\t\t\t}" + NL
			+ "\t\t\tcatch (IOException exception)" + NL + "\t\t\t{" + NL
			+ "\t\t\t\tif (!resourceToDiagnosticMap.containsKey(resource))" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\tresourceToDiagnosticMap.put(resource, analyzeResourceProblems(resource, exception));" + NL
	...
	protected final String TEXT_393 = NL + "\t/**" + NL
			...
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_394 = NL + "\tpublic void doSave(IProgressMonitor progressMonitor)" + NL + "\t{" + NL
	...
	protected final String TEXT_402 = "(IProgressMonitor monitor)" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\t// Save the resources to the file system." + NL + "\t\t\t\t\t//" + NL
			+ "\t\t\t\t\tboolean first = true;" + NL + "\t\t\t\t\t";
	protected final String TEXT_403 = " resources = editingDomain.getResourceSet().getResources();" + NL
			+ "\t\t\t\t\tfor (int i = 0; i < resources.size(); ++i)" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tResource resource = ";
	protected final String TEXT_404 = "(Resource)";
	protected final String TEXT_405 = "resources.get(i);" + NL
			+ "\t\t\t\t\t\tif ((first || !resource.getContents().isEmpty() || isPersisted(resource)) && !editingDomain.isReadOnly(resource))"
			+ NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\ttry" + NL + "\t\t\t\t\t\t\t{";
	protected final String TEXT_406 = NL + "\t\t\t\t\t\t\t\tlong timeStamp = resource.getTimeStamp();" + NL
			+ "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
			+ "\t\t\t\t\t\t\t\tif (resource.getTimeStamp() != timeStamp)" + NL + "\t\t\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\t\t\tsavedResources.add(resource);" + NL + "\t\t\t\t\t\t\t\t}";
	protected final String TEXT_407 = NL + "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
			+ "\t\t\t\t\t\t\t\tsavedResources.add(resource);";
	protected final String TEXT_408 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcatch (Exception exception)" + NL
			+ "\t\t\t\t\t\t\t{" + NL
			...
			+ NL + "\t\t\t//" + NL + "\t\t\t";
	protected final String TEXT_409 = ".INSTANCE.log(exception);" + NL + "\t\t}" + NL
			...
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_410 = NL + "\tpublic boolean isSaveAsAllowed()" + NL + "\t{" + NL + "\t\treturn true;"
	...
	protected final String TEXT_414 = NL + "\t\t\t\tprotected boolean isSave()" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\treturn true;" + NL + "\t\t\t\t}" + NL;
	protected final String TEXT_415 = NL + "\t\t\t\tprotected boolean processResources()" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\t";
	protected final String TEXT_416 = " uris = getURIs();" + NL + "\t\t\t\t\tif (uris.size() > 0)" + NL + "\t\t\t\t\t{"
			+ NL + "\t\t\t\t\t\tURI uri = ";
	protected final String TEXT_417 = "uris.get(0);" + NL + "\t\t\t\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_418 = "(uri));" + NL + "\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t\telse" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}.open();";
	protected final String TEXT_419 = NL + "\t\tString[] filters = ";
	protected final String TEXT_420 = "(String[])";
	protected final String TEXT_421 = "FILE_EXTENSION_FILTERS.toArray(new String[FILE_EXTENSION_FILTERS.size()]);" + NL
			+ "\t\tString[] files = ";
	protected final String TEXT_422 = ".openFilePathDialog(getSite().getShell(), ";
	protected final String TEXT_423 = ".SAVE, filters);" + NL + "\t\tif (files.length > 0)" + NL + "\t\t{" + NL
			+ "\t\t\tURI uri = URI.createFileURI(files[0]);" + NL + "\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_424 = "(uri));" + NL + "\t\t}";
	protected final String TEXT_425 = NL + "\t\tSaveAsDialog saveAsDialog = new SaveAsDialog(getSite().getShell());"
			...
			+ NL + "\t\t\t}" + NL + "\t\t}";
	protected final String TEXT_426 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
			+ "\tprotected void doSaveAs(URI uri, IEditorInput editorInput)" + NL + "\t{" + NL + "\t\t(";
	protected final String TEXT_427 = "editingDomain.getResourceSet().getResources().get(0)).setURI(uri);" + NL
	...
	protected final String TEXT_429 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_430 = NL + "\tpublic void gotoMarker(IMarker marker)" + NL + "\t{";
	protected final String TEXT_431 = NL + "\t\t";
	protected final String TEXT_432 = " targetObjects = markerHelper.getTargetObjects(editingDomain, marker);" + NL
			+ "\t\tif (!targetObjects.isEmpty())" + NL + "\t\t{" + NL + "\t\t\tsetSelectionToViewer(targetObjects);"
			+ NL + "\t\t}";
	protected final String TEXT_433 = NL + "\t\ttry" + NL + "\t\t{" + NL
	...
	protected final String TEXT_436 = NL + NL + "\t/**" + NL + "\t * This is called during startup." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_437 = NL + "\tpublic void init(IEditorSite site, IEditorInput editorInput)" + NL + "\t{"
	...
	protected final String TEXT_439 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_440 = NL + "\tpublic void setFocus()" + NL + "\t{";
	protected final String TEXT_441 = NL + "\t\tif (currentViewerPane != null)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_445 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_446 = NL + "\tpublic ISelection getSelection()" + NL + "\t{" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_447 = NL + "\tpublic void setSelection(ISelection selection)" + NL + "\t{" + NL
	...
	protected final String TEXT_452 = " collection = ((IStructuredSelection)selection).toList();" + NL
			+ "\t\t\t\tswitch (collection.size())" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tcase 0:" + NL + "\t\t\t\t\t{"
			+ NL + "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_NoObjectSelected\"));";
	protected final String TEXT_453 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tcase 1:" + NL
			+ "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tString text = new AdapterFactoryItemDelegator(adapterFactory).getText(collection.iterator().next());"
			+ NL + "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_SingleObjectSelected\", text));";
	protected final String TEXT_454 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tdefault:" + NL
			+ "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_MultiObjectSelected\", Integer.toString(collection.size())));";
	protected final String TEXT_455 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}"
			+ NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\t\tstatusLineManager.setMessage(\"\");";
	protected final String TEXT_456 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_457 = ".INSTANCE.getString(key);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_458 = ".INSTANCE.getString(key, new Object [] { s1 });" + NL + "\t}" + NL + "" + NL
			+ "\t/**" + NL
	...
	protected final String TEXT_459 = NL + "\tpublic void menuAboutToShow(IMenuManager menuManager)" + NL + "\t{" + NL
			...
			+ "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->"
			+ NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_460 = NL + "\tpublic void dispose()" + NL + "\t{" + NL
	...
	protected final String TEXT_462 = NL + "\t\tgetSite().getPage().removePartListener(partListener);" + NL + "" + NL
	...
	protected final String TEXT_465 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			+ "\t\t\t\tfilterAction.removePropertyChangeListener((";
	protected final String TEXT_466 = ") getActionBarContributor());" + NL + "\t\t\t\tfilterAction.dispose();" + NL
	...
	protected final String TEXT_472 = NL + "\t\t\tpropertySheetPage.dispose();" + NL + "\t\t}" + NL + "" + NL
