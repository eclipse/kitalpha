...
public class Editor extends org.eclipse.egf.emf.pattern.editor.Editor {
  ...
  protected final String TEXT_425 = NL + "\t\tSaveAsDialog saveAsDialog = new SaveAsDialog(getSite().getShell());" + NL
  ...
  protected final String TEXT_443 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
      ...
      + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_444 = NL + "\tpublic void addSelectionChangedListener(ISelectionChangedListener listener)"
  ...
  protected final String TEXT_451 = NL + "\t\t\tlistener.selectionChanged(new SelectionChangedEvent(this, selection));"
