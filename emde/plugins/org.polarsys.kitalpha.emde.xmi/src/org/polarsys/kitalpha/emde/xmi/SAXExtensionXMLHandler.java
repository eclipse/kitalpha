...
public class SAXExtensionXMLHandler extends SAXXMLHandler {
	 ...
	 * Constructor.
	 */
	public SAXExtensionXMLHandler(XMLResource xmiResource, XMLHelper helper, Map<?, ?> options) {
		super(xmiResource, helper, options);

		if (helper instanceof XMLExtensionHelperImpl) {
			((XMLExtensionHelperImpl) helper).setXMLHandler(this);
		}
	}
