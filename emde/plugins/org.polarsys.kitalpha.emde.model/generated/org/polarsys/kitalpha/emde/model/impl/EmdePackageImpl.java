...
public class EmdePackageImpl extends EPackageImpl implements EmdePackage {
  ...
  public static EmdePackage init() {
    ...
    EmdePackageImpl theEmdePackage = registeredEmdePackage instanceof EmdePackageImpl
        ? (EmdePackageImpl) registeredEmdePackage
        : new EmdePackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEReference(getExtensibleElement_OwnedExtensions(), this.getElementExtension(), null, "ownedExtensions", null, 0, //$NON-NLS-1$
        -1, ExtensibleElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
