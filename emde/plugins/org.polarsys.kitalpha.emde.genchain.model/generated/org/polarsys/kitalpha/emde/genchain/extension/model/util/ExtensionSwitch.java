	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtensionPackage.EMDE_GENERATION: {
				EmdeGeneration emdeGeneration = (EmdeGeneration)theEObject;
				T result = caseEmdeGeneration(emdeGeneration);
				if (result == null) result = caseEmfGeneration(emdeGeneration);
