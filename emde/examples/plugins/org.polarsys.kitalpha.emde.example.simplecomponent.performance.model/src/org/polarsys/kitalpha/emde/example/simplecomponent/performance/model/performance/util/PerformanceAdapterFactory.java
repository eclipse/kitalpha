 ...
 *******************************************************************************/
package org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.util;
...
public class PerformanceAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected PerformanceSwitch<Adapter> modelSwitch = new PerformanceSwitch<Adapter>() {
		@Override
		public Adapter caseSimpleVPPerformance(SimpleVPPerformance object) {
			return createSimpleVPPerformanceAdapter();
		}

		@Override
		public Adapter caseVPStatus(VPStatus object) {
			return createVPStatusAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.SimpleVPPerformance <em>Simple VP Performance</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSimpleVPPerformanceAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.VPStatus <em>VP Status</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVPStatusAdapter() {
		return null;
	}
