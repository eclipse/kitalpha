...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.emde.example.simplecomponent.model.simplecomponent.HardwareComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwareComponentItemProvider extends AbstractComponentItemProvider implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplecomponentPackage.Literals.HARDWARE_COMPONENT__ABSTRACT_COMPONENT);
		}
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_HardwareComponent_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case SimplecomponentPackage.HARDWARE_COMPONENT__ABSTRACT_COMPONENT:
