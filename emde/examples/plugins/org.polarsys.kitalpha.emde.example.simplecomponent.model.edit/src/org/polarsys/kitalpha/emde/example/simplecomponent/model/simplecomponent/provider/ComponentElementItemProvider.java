...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.emde.example.simplecomponent.model.simplecomponent.ComponentElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentElementItemProvider extends ExtensibleElementItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		String label = ((ComponentElement) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_ComponentElement_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
