 ...
 *******************************************************************************/
package org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.provider;
...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.SimpleVPPerformance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleVPPerformanceItemProvider extends ComponentElementItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public SimpleVPPerformanceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PerformancePackage.Literals.SIMPLE_VP_PERFORMANCE__STATUS);
		}
	...
	/**
	 * This returns SimpleVPPerformance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SimpleVPPerformance")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((SimpleVPPerformance) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_SimpleVPPerformance_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SimpleVPPerformance.class)) {
