...
public class PerformanceItemProviderAdapterFactory extends PerformanceAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.SimpleVPPerformance} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected SimpleVPPerformanceItemProvider simpleVPPerformanceItemProvider;

	/**
	 * This creates an adapter for a {@link org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.SimpleVPPerformance}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createSimpleVPPerformanceAdapter() {
		if (simpleVPPerformanceItemProvider == null) {
			simpleVPPerformanceItemProvider = new SimpleVPPerformanceItemProvider(this);
		}

		return simpleVPPerformanceItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.VPStatus} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected VPStatusItemProvider vpStatusItemProvider;

	/**
	 * This creates an adapter for a {@link org.polarsys.kitalpha.emde.example.simplecomponent.performance.model.performance.VPStatus}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createVPStatusAdapter() {
		if (vpStatusItemProvider == null) {
			vpStatusItemProvider = new VPStatusItemProvider(this);
		}

		return vpStatusItemProvider;
	}
	...
	public void dispose() {
		if (simpleVPPerformanceItemProvider != null)
			simpleVPPerformanceItemProvider.dispose();
		if (vpStatusItemProvider != null)
			vpStatusItemProvider.dispose();
	}
	...
	public static class EmdeChildCreationExtender implements IChildCreationExtender {
		 ...
		 */
		public ResourceLocator getResourceLocator() {
			return SimpleEditPlugin.INSTANCE;
		}
	}
