...
PRODUCT_PRJ_NAME="org.polarsys.kitalpha.releng.sdk.product"
...
if [ "$LOG" = "true" ]; then
	echo ">>> Run cmd 3 ReleaseProducts.sh prepare : Test if  BUILD_TYPE is to stable : BUILD_TYPE=$BUILD_TYPE"
fi
