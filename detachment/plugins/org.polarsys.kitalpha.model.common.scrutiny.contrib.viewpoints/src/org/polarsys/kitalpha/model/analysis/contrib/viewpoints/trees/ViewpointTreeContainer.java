...
package org.polarsys.kitalpha.model.analysis.contrib.viewpoints.trees;
...
public class ViewpointTreeContainer {
	...
	/**
	 * Add a new root hierarchy of viewpoint to roots list.
	 * A root hierarchy of viewpoint is hierarchy which has no parents (i.e hasParent() returns false)
	 * 
	 * @param vp is the root viewpoint hierarchy
	 * @return
	 */
	...
	private void getAllNsUrisOfChildren(
			Collection<IViewpointTreeDescription> children,
