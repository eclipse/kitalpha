...
package org.polarsys.kitalpha.example.tags.contextual.explorer.queries.tagdefinitionmodel;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		TagDefinitionModel object = (TagDefinitionModel) object_p;

		for (EObject eObject : object.getOwnedStatuses())
			result.add(eObject);
		for (EObject eObject : object.getOwnedKinds())
			result.add(eObject);
