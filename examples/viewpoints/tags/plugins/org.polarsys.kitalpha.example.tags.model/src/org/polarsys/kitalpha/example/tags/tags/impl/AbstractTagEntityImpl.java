 ...
 * @generated
 */
public abstract class AbstractTagEntityImpl extends EObjectImpl implements AbstractTagEntity {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TagsPackage.ABSTRACT_TAG_ENTITY__ID, oldId, id));
