 ...
 * <!-- end-user-doc -->
 * @see org.polarsys.kitalpha.example.tags.tags.TagsPackage#getColor()
 * @model
 * @generated
 */
public enum Color implements Enumerator {
	 ...
	 * @ordered
	 */
	WHITE(0, "White", "White"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	BLACK(1, "Black", "Black"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	BLUE(2, "Blue", "Blue"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	RED(3, "Red", "Red"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	GREEN(4, "Green", "Green"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	YELLOW(5, "Yellow", "Yellow"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @generated
	 */
	private static final Color[] VALUES_ARRAY = new Color[] { WHITE, BLACK, BLUE, RED, GREEN, YELLOW, OTHER, };
