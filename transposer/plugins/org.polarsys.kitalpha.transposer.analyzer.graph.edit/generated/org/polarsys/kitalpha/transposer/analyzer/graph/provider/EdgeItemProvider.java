...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.transposer.analyzer.graph.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_critical_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_critical_feature", "_UI_Edge_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 GraphPackage.Literals.EDGE__CRITICAL,
				 true,
				 false,
				 false,
