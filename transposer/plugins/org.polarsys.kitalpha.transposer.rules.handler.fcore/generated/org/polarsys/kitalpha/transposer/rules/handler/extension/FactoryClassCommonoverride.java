...
public class FactoryClassCommonoverride extends org.eclipse.egf.emf.pattern.model.FactoryClass {
	protected static String nl;

	public static synchronized FactoryClassCommonoverride create(String lineSeparator) {
		nl = lineSeparator;
		FactoryClassCommonoverride result = new FactoryClassCommonoverride();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_5 = NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL + " * The <b>Factory</b> for the model." + NL
	...
	protected final String TEXT_8 = NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL + " * An implementation of the model <b>Factory</b>." + NL + " * <!-- end-user-doc -->" + NL + " * @generated"
			+ NL + " */";
	...
	protected final String TEXT_16 = NL + "\t/**" + NL + "\t * The singleton instance of the factory." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */" + NL + "\t";
	...
	protected final String TEXT_22 = NL + "\t/**" + NL + "\t * Creates the default factory implementation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */";
	...
	protected final String TEXT_32 = ";" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (Exception exception)" + NL + "\t\t{" + NL + "\t\t\t";

	protected final String TEXT_33 = ".INSTANCE.log(exception);" + NL + "\t\t}" + NL + "\t\treturn new ";

	protected final String TEXT_34 = "();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Creates an instance of the factory." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";

	protected final String TEXT_35 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @generated" + NL + "\t */";

	protected final String TEXT_36 = NL + "\t@Override";

	protected final String TEXT_37 = NL + "\tpublic EObject create(EClass eClass)" + NL + "\t{" + NL + "\t\tswitch (eClass.getClassifierID())" + NL + "\t\t{";
	...
	protected final String TEXT_43 = NL + "\t\t\tdefault:" + NL + "\t\t\t\tthrow new IllegalArgumentException(\"The class '\" + eClass.getName() + \"' is not a valid classifier\");";
	...
	protected final String TEXT_47 = " eDataType, String initialValue)" + NL + "\t{" + NL + "\t\tswitch (eDataType.getClassifierID())" + NL + "\t\t{";

	protected final String TEXT_48 = ":" + NL + "\t\t\t\treturn create";

	protected final String TEXT_49 = "FromString(eDataType, initialValue);";

	protected final String TEXT_50 = NL + "\t\t\tdefault:" + NL + "\t\t\t\tthrow new IllegalArgumentException(\"The datatype '\" + eDataType.getName() + \"' is not a valid classifier\");";

	protected final String TEXT_51 = NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";

	protected final String TEXT_52 = NL + "\tpublic String convertToString(";

	protected final String TEXT_53 = " eDataType, Object instanceValue)" + NL + "\t{" + NL + "\t\tswitch (eDataType.getClassifierID())" + NL + "\t\t{";

	protected final String TEXT_54 = ":" + NL + "\t\t\t\treturn convert";

	protected final String TEXT_55 = "ToString(eDataType, instanceValue);";

	protected final String TEXT_56 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
	...
	protected final String TEXT_74 = ".get(literal);" + NL + "\t\tif (result == null) throw new IllegalArgumentException(\"The value '\" + literal + \"' is not a valid enumerator of '\" + ";
	...
	protected final String TEXT_92 = "(literal); stringTokenizer.hasMoreTokens(); )" + NL + "\t\t{" + NL + "\t\t\tString item = stringTokenizer.nextToken();";
	...
	protected final String TEXT_114 = ", null, null))" + NL + "\t\t\t{" + NL + "\t\t\t\treturn result;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (RuntimeException e)" + NL + "\t\t{" + NL
			+ "\t\t\texception = e;" + NL + "\t\t}";
	...
	protected final String TEXT_131 = "(initialValue); stringTokenizer.hasMoreTokens(); )" + NL + "\t\t{" + NL + "\t\t\tString item = stringTokenizer.nextToken();";
	...
	protected final String TEXT_135 = ".INSTANCE.validate(eDataType, result, null, null))" + NL + "\t\t\t{" + NL + "\t\t\t\treturn result;" + NL + "\t\t\t}" + NL + "\t\t}" + NL
			+ "\t\tcatch (RuntimeException e)" + NL + "\t\t{" + NL + "\t\t\texception = e;" + NL + "\t\t}";
	...
	protected final String TEXT_139 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic String convert";
	...
	protected final String TEXT_149 = NL + "\t\tif (instanceValue == null) return null;" + NL + "\t\tif (instanceValue.isEmpty()) return \"\";" + NL + "\t\t";
	...
	protected final String TEXT_159 = NL + "\t\t\tresult.append(' ');" + NL + "\t\t}" + NL + "\t\treturn result.substring(0, result.length() - 1);";
	...
	protected final String TEXT_168 = NL + "\t\t\t\tif (value != null) return value;" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e)" + NL + "\t\t\t{" + NL
	...
	protected final String TEXT_173 = NL + "\t\t\tif (value != null) return value;" + NL + "\t\t}" + NL + "\t\tcatch (Exception e)" + NL + "\t\t{" + NL
			+ "\t\t\t// Keep trying other member types until all have failed." + NL + "\t\t}";

	protected final String TEXT_174 = NL + "\t\tthrow new IllegalArgumentException(\"Invalid value: '\"+instanceValue+\"' for datatype :\"+";
	...
	protected final String TEXT_188 = NL + "\t\tthrow new IllegalArgumentException(\"Invalid value: '\"+instanceValue+\"' for datatype :\"+eDataType.getName());";
	...
	protected final String TEXT_191 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return a new object of class '<em>";
	...
	protected final String TEXT_195 = "</em>' corresponding the given literal." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
			+ "\t * @param literal a literal of the data type." + NL + "\t * @return a new instance value of the data type." + NL + "\t * @generated" + NL + "\t */" + NL + "\t";

	protected final String TEXT_196 = "(String literal);" + NL + "" + NL + "\t/**" + NL + "\t * Returns a literal representation of an instance of data type '<em>";

	protected final String TEXT_197 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param instanceValue an instance value of the data type." + NL
			+ "\t * @return a literal representation of the instance value." + NL + "\t * @generated" + NL + "\t */" + NL + "\tString convert";

	protected final String TEXT_198 = " instanceValue);" + NL;

	protected final String TEXT_199 = NL + "\t/**" + NL + "\t * Returns the package supported by this factory." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_202 = ")getEPackage();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @deprecated" + NL
			+ "\t * @generated" + NL + "\t */";
	...
	public FactoryClassCommonoverride() {
	...
	protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (isImplementation) {
			...
			genModel.addImport("org.polarsys.kitalpha.transposer.rules.handler.rules.common.spec.MappingElementSpec");
			genModel.addImport("org.polarsys.kitalpha.transposer.rules.handler.rules.common.spec.MappingPackageSpec");
			genModel.addImport("org.polarsys.kitalpha.transposer.rules.handler.rules.common.spec.MappingPossibilitySpec");
			genModel.addImport("org.polarsys.kitalpha.transposer.rules.handler.rules.common.spec.MappingSpec");
			stringBuffer.append(TEXT_4);
			...
			for (GenDataType genDataType : genPackage.getAllGenDataTypes()) {
				if (genDataType.isSerializable()) {
					if (genPackage.isDataTypeConverters()) {
						...
						} else if (genModel.useGenerics() && (genDataType.isArrayType() || !genDataType.getEcoreDataType().getETypeParameters().isEmpty()
					...
					if (genDataType instanceof GenEnum) {
						...
						if (genPackage.isDataTypeConverters()) {
							...
							&& (genDataType.isArrayType() || !genDataType.getEcoreDataType().getETypeParameters().isEmpty() || genDataType.getEcoreDataType().getInstanceTypeName().contains("<"))) {
						stringBuffer.append(TEXT_68);
						if (!genDataType.isObjectType()) {
							stringBuffer.append(TEXT_82);
							stringBuffer.append(genDataType.getImportedParameterizedObjectInstanceClassName());
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		if (this.parameter.getFactoryInterfaceName().equals("CommonFactory")) {
			return true;
		} else {
			return false;
		}
