...
public class FactoryClassContributionoverride extends org.eclipse.egf.emf.pattern.model.FactoryClass {
	protected static String nl;

	public static synchronized FactoryClassContributionoverride create(String lineSeparator) {
		nl = lineSeparator;
		FactoryClassContributionoverride result = new FactoryClassContributionoverride();
		nl = null;
		return result;
	}
	...
	public FactoryClassContributionoverride() {
	...
	protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (isImplementation) {
			...
			genModel.addImport("org.polarsys.kitalpha.transposer.rules.handler.rules.contribution.spec.ContributedPurposeSpec");
			stringBuffer.append(TEXT_4);
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		if (this.parameter.getFactoryInterfaceName().equals("ContributionFactory")) {
			return true;
		} else {
			return false;
		}
