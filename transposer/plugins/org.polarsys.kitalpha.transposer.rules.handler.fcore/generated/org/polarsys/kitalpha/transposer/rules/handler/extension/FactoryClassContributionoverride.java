...
public class FactoryClassContributionoverride extends
		org.eclipse.egf.emf.pattern.model.FactoryClass {
	protected static String nl;

	public static synchronized FactoryClassContributionoverride create(
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		if (this.parameter.getFactoryInterfaceName().equals(
				"ContributionFactory")) {
			return true;
		} else {
			return false;
