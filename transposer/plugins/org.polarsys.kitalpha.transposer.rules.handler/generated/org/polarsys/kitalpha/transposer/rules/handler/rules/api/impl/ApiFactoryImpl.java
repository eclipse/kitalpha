...
public class ApiFactoryImpl extends EFactoryImpl implements ApiFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ApiPackage.IPREMISE:
				return createIPremiseFromString(eDataType, initialValue);
			case ApiPackage.IRULE:
				return createIRuleFromString(eDataType, initialValue);
			case ApiPackage.IDOMAIN_HELPER:
				return createIDomainHelperFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ApiPackage.IPREMISE:
				return convertIPremiseToString(eDataType, instanceValue);
			case ApiPackage.IRULE:
				return convertIRuleToString(eDataType, instanceValue);
			case ApiPackage.IDOMAIN_HELPER:
				return convertIDomainHelperToString(eDataType, instanceValue);
			case ApiPackage.ICONTEXT:
	 ...
	 * @generated
	 */
	public IPremise createIPremiseFromString(EDataType eDataType, String initialValue) {
		return (IPremise)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertIPremiseToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
	 ...
	 * @generated
	 */
	public IRule<?> createIRuleFromString(EDataType eDataType, String initialValue) {
		return (IRule<?>)super.createFromString(initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertIRuleToString(EDataType eDataType, Object instanceValue) {
	 ...
	 * @generated
	 */
	public IDomainHelper createIDomainHelperFromString(EDataType eDataType, String initialValue) {
		return (IDomainHelper)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertIDomainHelperToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
	 ...
	 * @generated
	 */
	public IContext createIContextFromString(EDataType eDataType, String initialValue) {
		return (IContext)super.createFromString(eDataType, initialValue);
	}
