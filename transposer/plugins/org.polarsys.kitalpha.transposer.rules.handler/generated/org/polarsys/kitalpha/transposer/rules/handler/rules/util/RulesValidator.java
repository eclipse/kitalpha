 ...
 * <!-- end-user-doc -->
 * @see org.polarsys.kitalpha.transposer.rules.handler.rules.RulesPackage
 * @generated
 */
public class RulesValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final RulesValidator INSTANCE = new RulesValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "org.polarsys.kitalpha.transposer.rules.handler.rules"; //$NON-NLS-1$
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			case RulesPackage.PURPOSE_REGISTRY:
				return validatePurposeRegistry((PurposeRegistry)value, diagnostics, context);
			...
			case RulesPackage.MAPPING_POSSIBILITY_RESOLUTION_EXCEPTION:
				return validateMappingPossibilityResolutionException((MappingPossibilityResolutionException)value, diagnostics, context);
			case RulesPackage.MAPPING_RESOLUTION_EXCEPTION:
				return validateMappingResolutionException((MappingResolutionException)value, diagnostics, context);
			case RulesPackage.AMBIGUOUS_MAPPING_EXCEPTION:
				return validateAmbiguousMappingException((AmbiguousMappingException)value, diagnostics, context);
			case RulesPackage.RULE_DEFINITION_EXCEPTION:
				return validateRuleDefinitionException((RuleDefinitionException)value, diagnostics, context);
			case RulesPackage.RULE_EXECUTION_EXCEPTION:
				return validateRuleExecutionException((RuleExecutionException)value, diagnostics, context);
			default:
				return true;
		}
	}
	 ...
	 * @generated
	 */
	public boolean validatePurposeRegistry(PurposeRegistry purposeRegistry, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(purposeRegistry, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public boolean validateMappingPossibilityResolutionException(MappingPossibilityResolutionException mappingPossibilityResolutionException, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateMappingResolutionException(MappingResolutionException mappingResolutionException, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateAmbiguousMappingException(AmbiguousMappingException ambiguousMappingException, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateRuleDefinitionException(RuleDefinitionException ruleDefinitionException, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateRuleExecutionException(RuleExecutionException ruleExecutionException, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
