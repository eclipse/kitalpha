...
package org.polarsys.kitalpha.transposer.rules.handler.rules.runtime.util;
...
public class RuntimeAdapterFactory extends AdapterFactoryImpl {
	...
	protected RuntimeSwitch<Adapter> modelSwitch =
		new RuntimeSwitch<Adapter>() {
			@Override
			public Adapter caseRuntimePurpose(RuntimePurpose object) {
				return createRuntimePurposeAdapter();
			}
			@Override
			public Adapter caseIPurpose(IPurpose object) {
				return createIPurposeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.kitalpha.transposer.rules.handler.rules.runtime.RuntimePurpose <em>Purpose</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRuntimePurposeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.kitalpha.transposer.rules.handler.rules.api.IPurpose <em>IPurpose</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
