...
public class RuntimeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RuntimePackage.RUNTIME_PURPOSE: {
				RuntimePurpose runtimePurpose = (RuntimePurpose)theEObject;
				T result = caseRuntimePurpose(runtimePurpose);
				if (result == null) result = caseIPurpose(runtimePurpose);
	 ...
	 * @generated
	 */
	public T caseRuntimePurpose(RuntimePurpose object) {
		return null;
	}
