...
public class RulesAdapterFactory extends AdapterFactoryImpl {
	...
	protected RulesSwitch<Adapter> modelSwitch =
		new RulesSwitch<Adapter>() {
			@Override
			public Adapter casePurposeRegistry(PurposeRegistry object) {
				return createPurposeRegistryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.kitalpha.transposer.rules.handler.rules.PurposeRegistry <em>Purpose Registry</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPurposeRegistryAdapter() {
		return null;
	}
