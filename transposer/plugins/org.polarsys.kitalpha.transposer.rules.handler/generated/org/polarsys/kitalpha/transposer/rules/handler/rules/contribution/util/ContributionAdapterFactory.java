...
public class ContributionAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ContributionSwitch<Adapter> modelSwitch =
		new ContributionSwitch<Adapter>() {
			@Override
			public Adapter caseContributedPurpose(ContributedPurpose object) {
				return createContributedPurposeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.kitalpha.transposer.rules.handler.rules.contribution.ContributedPurpose <em>Contributed Purpose</em>}'.
	 * <!-- begin-user-doc -->
