...
public class GenericTopologicalSorter extends AbstractTopologicalSorter {
	...
	/**
	 * @see org.polarsys.kitalpha.ccm.scheduler.scheduler.AbstractTopologicalSorter#getWork()
	 */
	@Override
	...
	/**
	 * @see org.polarsys.kitalpha.ccm.scheduler.scheduler.AbstractTopologicalSorter#sort()
	 */
	@Override
