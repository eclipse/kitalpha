...
public class GraphElement_Class_getGenFeature_override
  ...
  protected final String TEXT_1 = " /**" + NL + "    * <!-- begin-user-doc -->" + NL + "    * <!-- end-user-doc -->"
      + NL + "    * @generated" + NL + "    */" + NL + " @SuppressWarnings(\"unchecked\")" + NL + " public ";
  protected final String TEXT_2 = " ";
  protected final String TEXT_3 = "_";
  protected final String TEXT_4 = "() " + NL + "    {" + NL + "     if (!(content instanceof ";
  protected final String TEXT_5 = "))" + NL + "\t\t\t\treturn content;" + NL
      + "\t\t\telse if (content != null && ((EObject) content).eIsProxy()) {" + NL + "\t\t\t" + NL
      + "\t\t\t\tInternalEObject oldContent = (";
  protected final String TEXT_6 = ") content;" + NL + "\t\t\t\tcontent = (ContentClass) eResolveProxy(oldContent);" + NL
      + "\t\t\t\tif (content != oldContent) {" + NL + "\t\t\t\t\tif (eNotificationRequired())" + NL
      + "\t\t\t\t\t\teNotify(new ENotificationImpl(this, Notification.RESOLVE," + NL
      + "\t\t\t\t\t\t\t\tGraphPackage.GRAPH_ELEMENT__CONTENT, oldContent," + NL + "\t\t\t\t\t\t\t\tcontent));" + NL
      + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\treturn content;" + NL + "    }";
  ...
  public boolean preCondition(PatternContext ctx) throws Exception {
    if ("GraphElement".equals(genFeature.getGenClass().getEcoreClass().getName())
