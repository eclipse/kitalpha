...
public class GraphSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GraphPackage.VERTEX: {
				...
				if (result == null) result = caseGraphElement(vertex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public <ContentClass> T caseGraphElement(GraphElement<ContentClass> object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public <ContentClass> T caseVertex(Vertex<ContentClass> object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public <ContentClass> T caseEdge(Edge<ContentClass> object) {
		return null;
	}
