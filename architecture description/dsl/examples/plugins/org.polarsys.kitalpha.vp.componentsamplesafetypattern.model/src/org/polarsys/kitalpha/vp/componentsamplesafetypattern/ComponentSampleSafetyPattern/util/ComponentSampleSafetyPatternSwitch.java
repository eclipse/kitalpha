...
public class ComponentSampleSafetyPatternSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ComponentSampleSafetyPatternPackage.SAFETY_PACKAGE: {
			SafetyPackage safetyPackage = (SafetyPackage) theEObject;
			T result = caseSafetyPackage(safetyPackage);
			if (result == null)
				result = casePackage(safetyPackage);
			if (result == null)
				result = caseComponentElement(safetyPackage);
			if (result == null)
				result = caseExtensibleElement(safetyPackage);
			if (result == null)
				result = caseElement(safetyPackage);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Safety Package</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Safety Package</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSafetyPackage(SafetyPackage object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Safety Mode</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Safety Mode</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSafetyMode(SafetyMode object) {
		return null;
	}
...
} //ComponentSampleSafetyPatternSwitch
