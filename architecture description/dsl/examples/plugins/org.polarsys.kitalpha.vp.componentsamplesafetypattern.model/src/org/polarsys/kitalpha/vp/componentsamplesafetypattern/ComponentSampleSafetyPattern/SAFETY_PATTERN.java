...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>SAFETY PATTERN</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.polarsys.kitalpha.vp.componentsamplesafetypattern.ComponentSampleSafetyPattern.ComponentSampleSafetyPatternPackage#getSAFETY_PATTERN()
 * @model
 * @generated
 */
public enum SAFETY_PATTERN implements Enumerator {
	 ...
	 * @ordered
	 */
	INTEGRITY(0, "INTEGRITY", "INTEGRITY"), //$NON-NLS-1$ //$NON-NLS-2$
	...
	/**
	 * An array of all the '<em><b>SAFETY PATTERN</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static SAFETY_PATTERN get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SAFETY_PATTERN result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private SAFETY_PATTERN(int value, String name, String literal) {
		this.value = value;
		this.name = name;
