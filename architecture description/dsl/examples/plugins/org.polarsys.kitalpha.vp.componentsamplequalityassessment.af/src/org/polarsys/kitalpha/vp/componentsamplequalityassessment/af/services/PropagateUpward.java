 ...
 *
 */
public class PropagateUpward extends PropagationService{
	...
	protected List<EObject> perform(final Object[] selection) {
		...
		for (Object o : selection) {
			...
			if (qa != null) {
				...
				if (eobj.eContainer() instanceof ExtensibleElement) {
					QualityAssessment copy = EcoreUtil.copy(qa);
					((ExtensibleElement) eobj.eContainer()).getOwnedExtensions().add(copy);
					additions.add(copy);
				}
			}
		}
