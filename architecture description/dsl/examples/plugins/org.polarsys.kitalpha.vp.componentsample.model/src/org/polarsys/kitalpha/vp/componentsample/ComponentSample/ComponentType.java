 ...
 * <!-- end-user-doc -->
 * @see org.polarsys.kitalpha.vp.componentsample.ComponentSample.ComponentSamplePackage#getComponentType()
 * @model
 * @generated
 */
public enum ComponentType implements Enumerator {
	 ...
	 * @ordered
	 */
	BEHAVIOUR(0, "Behaviour", "Behaviour"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final int BEHAVIOUR_VALUE = 0;
	 ...
	 * @generated
	 */
	private static final ComponentType[] VALUES_ARRAY = new ComponentType[] { BEHAVIOUR, DATA, SERVICE, };
