...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.vp.componentsampleperformance.ComponentSamplePerformance.Performance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PerformanceItemProvider extends ComponentElementItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_Performance_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
