 ...
 *
 */
public class UnreferenceComponentSampleQualityAssessmentViewpointActivity extends AbstractHyperlinkAdapter {

	/**
	 * Default constructor
	 */
	public UnreferenceComponentSampleQualityAssessmentViewpointActivity() {
	 ...
	 */
	public UnreferenceComponentSampleQualityAssessmentViewpointActivity(EObject root) {
		super(root);
	}
