...
4. In "URL du repository" section, enter git http://ComponentSample/ComponentSample.git
5. In "Repertoire local du module" section, enter "svn/svn_viewpoint"
6. In "Build" section, click on "avanc�" button
7. In "Fichier du build", enter C:/Users/S0045853/git/kitalpha/kitalpha/architecture description/dsl/examples/plugins/org.polarsys.kitalpha.vp.componentsample.releng/releng-scripts/build_ComponentSample/releng/build.xml
