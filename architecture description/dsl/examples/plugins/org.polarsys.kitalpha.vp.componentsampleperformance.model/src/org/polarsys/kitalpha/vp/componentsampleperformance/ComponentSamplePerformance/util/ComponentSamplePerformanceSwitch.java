 ...
 * @generated
 */
public class ComponentSamplePerformanceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ComponentSamplePerformancePackage modelPackage;
	 ...
	 * @generated
	 */
	public ComponentSamplePerformanceSwitch() {
		if (modelPackage == null) {
			modelPackage = ComponentSamplePerformancePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ComponentSamplePerformancePackage.PERFORMANCE: {
			...
			if (result == null)
				result = caseComponentElement(performance);
			if (result == null)
				result = caseElementExtension(performance);
			if (result == null)
				result = caseExtensibleElement(performance);
			if (result == null)
				result = caseElement(performance);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ComponentSamplePerformancePackage.PERFORMANCE_STATUS: {
			PerformanceStatus performanceStatus = (PerformanceStatus) theEObject;
			T result = casePerformanceStatus(performanceStatus);
			if (result == null)
				result = caseComponentElement(performanceStatus);
			if (result == null)
				result = caseExtensibleElement(performanceStatus);
			if (result == null)
				result = caseElement(performanceStatus);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Performance Status</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Performance Status</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePerformanceStatus(PerformanceStatus object) {
		return null;
	}
...
} //ComponentSamplePerformanceSwitch
