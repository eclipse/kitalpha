...
public class ComponentSampleQualityAssessmentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ComponentSampleQualityAssessmentPackage.QUALITY_ASSESSMENT: {
			QualityAssessment qualityAssessment = (QualityAssessment) theEObject;
			T result = caseQualityAssessment(qualityAssessment);
			if (result == null)
				result = caseComponentElement(qualityAssessment);
			if (result == null)
				result = caseElementExtension(qualityAssessment);
			if (result == null)
				result = caseExtensibleElement(qualityAssessment);
			if (result == null)
				result = caseElement(qualityAssessment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ComponentSampleQualityAssessmentPackage.QUALITY_MEASURE: {
			QualityMeasure qualityMeasure = (QualityMeasure) theEObject;
			T result = caseQualityMeasure(qualityMeasure);
			if (result == null)
				result = caseComponentElement(qualityMeasure);
			if (result == null)
				result = caseExtensibleElement(qualityMeasure);
			if (result == null)
				result = caseElement(qualityMeasure);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quality Assessment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quality Assessment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQualityAssessment(QualityAssessment object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quality Measure</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quality Measure</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQualityMeasure(QualityMeasure object) {
		return null;
	}
...
} //ComponentSampleQualityAssessmentSwitch
