 ...
 *
 */
public class ReferenceComponentSampleSafetyViewpointActivity extends AbstractHyperlinkAdapter {

	/**
	 * Default constructor
	 */
	public ReferenceComponentSampleSafetyViewpointActivity() {
	 ...
	 */
	public ReferenceComponentSampleSafetyViewpointActivity(EObject root) {
		super(root);
	}
