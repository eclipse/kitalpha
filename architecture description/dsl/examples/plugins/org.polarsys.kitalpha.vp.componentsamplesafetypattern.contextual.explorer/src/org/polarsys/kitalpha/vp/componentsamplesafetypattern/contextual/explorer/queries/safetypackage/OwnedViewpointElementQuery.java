...
package org.polarsys.kitalpha.vp.componentsamplesafetypattern.contextual.explorer.queries.safetypackage;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		SafetyPackage object = (SafetyPackage) object_p;

		for (EObject eObject : object.getModes())
			result.add(eObject);
