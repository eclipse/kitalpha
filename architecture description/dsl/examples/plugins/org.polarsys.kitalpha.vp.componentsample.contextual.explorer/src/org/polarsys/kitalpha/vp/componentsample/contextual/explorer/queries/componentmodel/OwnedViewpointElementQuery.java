...
package org.polarsys.kitalpha.vp.componentsample.contextual.explorer.queries.componentmodel;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ComponentModel object = (ComponentModel) object_p;

		for (EObject eObject : object.getPackages())
			result.add(eObject);
