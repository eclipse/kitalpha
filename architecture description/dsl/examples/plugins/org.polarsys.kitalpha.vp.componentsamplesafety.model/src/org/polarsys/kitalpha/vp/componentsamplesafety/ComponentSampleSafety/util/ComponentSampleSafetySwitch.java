...
public class ComponentSampleSafetySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ComponentSampleSafetyPackage.SAFETY: {
			...
			if (result == null)
				result = caseComponentElement(safety);
			if (result == null)
				result = caseElementExtension(safety);
			if (result == null)
				result = caseExtensibleElement(safety);
			if (result == null)
				result = caseElement(safety);
			if (result == null)
