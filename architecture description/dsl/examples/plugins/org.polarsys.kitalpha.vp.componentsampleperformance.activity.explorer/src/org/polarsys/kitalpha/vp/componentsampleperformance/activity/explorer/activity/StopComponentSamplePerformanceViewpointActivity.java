 ...
 *
 */
public class StopComponentSamplePerformanceViewpointActivity extends AbstractComponentsampleHyperLink {

	/**
	* Default constructor
	*/
	public StopComponentSamplePerformanceViewpointActivity() {
	 ...
	 */
	public StopComponentSamplePerformanceViewpointActivity(EObject root) {
		super(root);
	}
	...
	protected void linkPressed(HyperlinkEvent event, EObject project_p, Session session) {
		...
		MessageDialog.openInformation(shell, "Activity Explorer - StopComponentSamplePerformanceViewpoint",
				"Default implementation for StopComponentSamplePerformanceViewpoint.\n org.polarsys.kitalpha.vp.componentsampleperformance.activity.explorer.activity.StopComponentSamplePerformanceViewpointActivity.java");
	}
