 ...
 * @generated
 */
public class ComponentSampleSafetyItemProviderAdapterFactory extends
		ComponentSampleSafetyAdapterFactory implements
	...
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(
			...
			ComponentSampleSafetyPackage.eNS_URI);
			...
			public Object caseExtensibleElement(ExtensibleElement object) {
				...
				if (ModelExtensionHelper
						...
						.isExtensionModelDisabled(
								...
								"http://www.polarsys.org/kitalpha/ComponentSampleSafety/1.0.0")) { //$NON-NLS-1$
					return null;
				}
				// end-extension-code
				// begin-extension-code
				{
					CommandParameter commandParameter = createChildParameter(
							...
							ComponentSampleSafetyFactory.eINSTANCE
									.createSafety());
