 ...
 * @generated
 */
public class SafetyItemProvider extends ComponentElementItemProvider implements
	...
	protected void addCriticalityPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Safety_criticality_feature", "_UI_Safety_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ComponentSampleSafetyPackage.Literals.SAFETY__CRITICALITY,
						true, false, false,
	...
	protected void addDalPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Safety_dal_feature", "_UI_Safety_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ComponentSampleSafetyPackage.Literals.SAFETY__DAL,
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
						// begin-extension-code
						null));
	...
	protected void addStatePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Safety_state_feature", "_UI_Safety_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ComponentSampleSafetyPackage.Literals.SAFETY__STATE,
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
						// begin-extension-code
						null));
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Safety")); //$NON-NLS-1$
	}
