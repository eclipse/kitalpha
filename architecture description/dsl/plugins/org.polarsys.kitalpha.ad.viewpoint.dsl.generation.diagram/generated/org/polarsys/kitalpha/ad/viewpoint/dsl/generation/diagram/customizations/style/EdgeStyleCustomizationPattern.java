...
public class EdgeStyleCustomizationPattern extends
  ...
  protected void method_initSizeComputationExpressionData(final StringBuffer out, final PatternContext ctx)
    ...
    if (parameter.eIsSet(VpstylecustomizationPackage.eINSTANCE.getEdgeStyleCustomization_SizeComputationExpression())) {
      ...
      if (expressionElement != null) {
        final String sceExpression = DiagramExpressionUtil.getAbstractComputableElementExpression(expressionElement,
  ...
  protected void method_initLabelStyleDescriptionData(final StringBuffer out, final PatternContext ctx)
    ...
    if (parameter
      ...
      set_beginLabelStyleDescription(
          new StylePropertyNameValueCouple("beginLabelStyleDescription", parameter.getBeginLabelStyleDescription()));
    }

    if (parameter.eIsSet(VpstylecustomizationPackage.eINSTANCE.getEdgeStyleCustomization_EndLabelStyleDescription())) {
      set_endLabelStyleDescription(
          new StylePropertyNameValueCouple("endLabelStyleDescription", parameter.getEndLabelStyleDescription()));
    }

    if (parameter
        .eIsSet(VpstylecustomizationPackage.eINSTANCE.getEdgeStyleCustomization_CenterLabelStyleDescription())) {
      set_centerLabelStyleDescription(
          new StylePropertyNameValueCouple("centerLabelStyleDescription", parameter.getCenterLabelStyleDescription()));
    }
