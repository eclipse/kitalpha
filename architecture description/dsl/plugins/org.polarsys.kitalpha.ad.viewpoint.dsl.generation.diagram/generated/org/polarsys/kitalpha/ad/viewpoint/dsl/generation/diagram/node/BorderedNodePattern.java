...
//Generated on Tue Jul 15 11:14:57 CEST 2014 with EGF 1.2.0.v20140710-0659
...
public class BorderedNodePattern
			...
			if (vpStyle != null) {
				...
				if (label != null) {
					...
					if (label.isBold() && label.isItalic()) {
						...
						if (label.isBold())
							nStyleDesc.setLabelFormat(FontFormat.BOLD_LITERAL);
	...
	public void set_parameter(
			org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpdiagram.BorderedNode parameter) {
