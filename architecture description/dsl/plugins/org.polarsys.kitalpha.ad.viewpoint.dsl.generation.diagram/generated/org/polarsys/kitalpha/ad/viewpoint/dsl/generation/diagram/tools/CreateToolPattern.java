...
public class CreateToolPattern
  ...
  protected void method_createConcretTool(final StringBuffer out, final PatternContext ctx) throws Exception {
    ...
    **/
    ...
    String mParameters = "(" + VSMVariable.sourceView.getInnerVariable() + "," + VSMVariable.target.getInnerVariable()
    ...
    case VpdiagramPackage.CONTAINER:
      ...
      if (useJavaService) {
        ...
        if (javaServiceData != null) {
          ...
          n_if.setConditionExpression(
              SiriusExpressionHelper.getExpressoin(n_method_name + pContainerView, ExpressionInterpreter.Service));
        ...
        if (edge_mapping.getThe_domain() instanceof EdgeDomainElement) {
          ...
          if (javaServiceData != null) {
            ...
            iv.setConditionExpression(
                SiriusExpressionHelper.getExpressoin(e_method_name + mParameters, ExpressionInterpreter.Service));
