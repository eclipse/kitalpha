...
//Generated on Tue Jul 15 11:18:58 CEST 2014 with EGF 1.2.0.v20140710-0659
...
public class ReconnectEdgeSource_ElementBasedTool
		extends
	...
	protected void method_createToolOperations(final StringBuffer out,
		...
		if (reference != null) {
			...
			t_setValue.setValueExpression(VSMVariable.target
					.getExpressionVariable());
			...
			t_unset.setElementExpression(VSMVariable.source
					.getExpressionVariable());
