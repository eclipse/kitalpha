...
public class AbstractNodeStyleCustomizationPattern extends
  ...
  protected void method_initExpressionsData(final StringBuffer out, final PatternContext ctx) throws Exception {
    if (dslvpElement.eIsSet(
        VpstylecustomizationPackage.eINSTANCE.getAbstractNodeStyleCustomization_BorderSizeComputationExpression())) {
      ...
      if (expressionElement != null) {
        final String bscExpression = DiagramExpressionUtil.getAbstractComputableElementExpression(expressionElement,
    ...
    if (dslvpElement
      ...
      final AbstractComputableElement expressionElement = expression.getOwnedExpressionElement();
      if (expressionElement != null) {
        final String ttExpression = DiagramExpressionUtil.getAbstractComputableElementExpression(expressionElement,
            VSMVariable.view, VSMVariable.container);
