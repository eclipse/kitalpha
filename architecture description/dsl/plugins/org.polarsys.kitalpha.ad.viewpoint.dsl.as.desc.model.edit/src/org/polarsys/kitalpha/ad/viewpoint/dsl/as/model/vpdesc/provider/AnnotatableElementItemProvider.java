...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpdesc.AnnotatableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotatableElementItemProvider extends NamedElementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VpdescPackage.Literals.ANNOTATABLE_ELEMENT__OWNED_ANNOTATIONS);
		}
	...
	public String getText(Object object) {
		...
		String label = ((AnnotatableElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AnnotatableElement_type") :
			getString("_UI_AnnotatableElement_type") + " " + label;
