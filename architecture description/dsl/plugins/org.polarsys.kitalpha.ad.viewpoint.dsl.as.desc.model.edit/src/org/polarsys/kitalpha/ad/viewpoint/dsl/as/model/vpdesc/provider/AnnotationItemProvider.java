...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpdesc.Annotation} object.
 * <!-- begin-user-doc -->
...
public class AnnotationItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VpdescPackage.Literals.ANNOTATION__SOURCE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VpdescPackage.Literals.ANNOTATION__OWNED_DETAILS);
		}
