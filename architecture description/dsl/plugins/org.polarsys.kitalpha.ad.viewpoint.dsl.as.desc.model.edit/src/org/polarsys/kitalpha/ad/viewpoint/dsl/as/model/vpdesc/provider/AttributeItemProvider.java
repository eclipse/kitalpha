...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpdesc.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends AbstractFeatureItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VpdescPackage.Literals.ATTRIBUTE__IS_ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VpdescPackage.Literals.ATTRIBUTE__OWNED_VALUES);
			childrenFeatures.add(VpdescPackage.Literals.ATTRIBUTE__OWNED_TYPE);
		}
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
				...
				newChildDescriptors.add
					(createChildParameter
						(VpdescPackage.Literals.ATTRIBUTE__OWNED_VALUES,
						 VpdescFactory.eINSTANCE.createValue()));



				newChildDescriptors.add
					(createChildParameter
						(VpdescPackage.Literals.ATTRIBUTE__OWNED_TYPE,
						 VpdescFactory.eINSTANCE.createLocalAttributeType()));
				...
				newChildDescriptors.add
					(createChildParameter
						(VpdescPackage.Literals.ATTRIBUTE__OWNED_TYPE,
						 VpdescFactory.eINSTANCE.createExternalAttributeType()));
