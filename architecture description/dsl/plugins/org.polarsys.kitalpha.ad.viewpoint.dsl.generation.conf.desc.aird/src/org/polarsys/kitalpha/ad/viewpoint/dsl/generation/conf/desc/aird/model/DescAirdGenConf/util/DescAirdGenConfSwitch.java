 ...
 * @generated
 */
public class DescAirdGenConfSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DescAirdGenConfPackage.AIRD_GENERATION_CONFIGURATION: {
				AirdGenerationConfiguration airdGenerationConfiguration = (AirdGenerationConfiguration)theEObject;
				T result = caseAirdGenerationConfiguration(airdGenerationConfiguration);
				if (result == null) result = caseExtensionGeneratrionConfiguration(airdGenerationConfiguration);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Aird Generation Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Aird Generation Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAirdGenerationConfiguration(AirdGenerationConfiguration object) {
		return null;
	}
