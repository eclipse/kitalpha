...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpdiagram.BorderedNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BorderedNodeItemProvider extends AbstractNodeItemProvider
	 ...
	 * @generated
	 */
	public BorderedNodeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewpointElement_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewpointElement_id_feature", "_UI_ViewpointElement_type"),
				 VpdescPackage.Literals.VIEWPOINT_ELEMENT__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VpdescPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addImportsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BorderedNode_imports_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BorderedNode_imports_feature", "_UI_BorderedNode_type"),
				 VpdiagramPackage.Literals.BORDERED_NODE__IMPORTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VpdiagramPackage.Literals.BORDERED_NODE__STYLE);
		}
	...
	public Object getImage(Object object) {
		BorderedNode bNode = (BorderedNode) object;
		if (bNode.getImports() != null)
			return overlayImage(object,
					getResourceLocator().getImage("full/obj16/IBorderedNode")); //$NON-NLS-1$
		else
			return overlayImage(object,
					getResourceLocator().getImage("full/obj16/BorderedNode")); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BorderedNode.class)) {
