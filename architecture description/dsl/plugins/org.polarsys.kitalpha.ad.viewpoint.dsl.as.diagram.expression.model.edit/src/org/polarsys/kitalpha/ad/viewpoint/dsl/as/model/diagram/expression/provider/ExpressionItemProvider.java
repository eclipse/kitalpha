...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.diagram.expression.Expression} object.
 * <!-- begin-user-doc -->
...
public class ExpressionItemProvider extends ItemProviderAdapter 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExpressionPackage.Literals.EXPRESSION__VALUE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionPackage.Literals.EXPRESSION__EXPRESSION_ELEMENTS);
		}
