...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpservices.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider extends AbstractServicesElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VpservicesPackage.Literals.RULE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addClassPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_class_feature", "_UI_Rule_type"),
				 VpservicesPackage.Literals.RULE__CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		String image = "full/obj16/Rule";

		Rule rule = (Rule) object;

		switch (rule.getType()) {
		case EM_FVALIDATION:
			image = "full/obj16/EMFRule";
			break;

		case JAVA:
			image = "full/obj16/JavaRule";
			break;
