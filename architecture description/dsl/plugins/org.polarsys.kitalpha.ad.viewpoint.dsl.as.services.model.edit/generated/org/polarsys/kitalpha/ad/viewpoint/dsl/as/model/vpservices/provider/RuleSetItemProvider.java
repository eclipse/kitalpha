...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpservices.RuleSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleSetItemProvider extends AspectItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VpservicesPackage.Literals.RULE_SET__VP_RULES);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? "["
				...
				: "[" + getString("_UI_RuleSet_type") + "] " + label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add
			(createChildParameter
				(VpservicesPackage.Literals.RULE_SET__VP_RULES,
				 VpservicesFactory.eINSTANCE.createRule()));
