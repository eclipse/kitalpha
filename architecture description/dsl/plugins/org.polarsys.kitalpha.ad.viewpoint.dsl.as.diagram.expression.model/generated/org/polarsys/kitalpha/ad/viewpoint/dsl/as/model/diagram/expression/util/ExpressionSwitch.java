...
public class ExpressionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExpressionPackage.DOMAIN_ELEMENT: {
				...
				if (result == null) result = caseForeignExpressionElement(domainElement);
				if (result == null) result = caseExpressionElement(domainElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExpressionPackage.FOREIGN_EXPRESSION_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Foreign Expression Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Foreign Expression Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseForeignExpressionElement(ForeignExpressionElement object) {
		return null;
	}
