...
public class ExpressionFactoryImpl extends EFactoryImpl implements
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ExpressionPackage.JAVA_ELEMENT: return createJavaElement();
			case ExpressionPackage.DOMAIN_ELEMENT: return createDomainElement();
			case ExpressionPackage.STRING_ELEMENT: return createStringElement();
			default:
