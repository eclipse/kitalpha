...
public class ManageMissingViewpointsTask implements ITaskProduction {
	...
	public void doExecute(ITaskProductionContext productionContext,
		...
		ArchitectureFramework af_d = (ArchitectureFramework) domainModel.getContent().get(0);
		
		AFViewpointGenerationOrchetrator orchetrator = new AFViewpointGenerationOrchetrator();
		orchetrator.orchestrateVPGeneration(af_d, afModelStringURI, monitor);
	}
