...
public class VpservicesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VpservicesPackage.RULE_SET: {
				...
				if (result == null) result = caseAspect(ruleSet);
				if (result == null) result = caseNamedElement(ruleSet);
				if (result == null) result = caseViewpointElement(ruleSet);
			...
			case VpservicesPackage.SERVICE_SET: {
				...
				if (result == null) result = caseAspect(serviceSet);
				if (result == null) result = caseNamedElement(serviceSet);
				if (result == null) result = caseViewpointElement(serviceSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VpservicesPackage.ABSTRACT_SERVICES_ELEMENT: {
				AbstractServicesElement abstractServicesElement = (AbstractServicesElement)theEObject;
				T result = caseAbstractServicesElement(abstractServicesElement);
				if (result == null) result = caseNamedElement(abstractServicesElement);
				if (result == null) result = caseViewpointElement(abstractServicesElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VpservicesPackage.RULE: {
				...
				if (result == null) result = caseAbstractServicesElement(rule);
			...
			case VpservicesPackage.SERVICE: {
				...
				if (result == null) result = caseAbstractServicesElement(service);
			...
			case VpservicesPackage.PROPERTY_SET: {
				...
				if (result == null) result = caseAspect(propertySet);
				if (result == null) result = caseNamedElement(propertySet);
				if (result == null) result = caseViewpointElement(propertySet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VpservicesPackage.PROPERTY: {
				...
				if (result == null) result = caseAbstractServicesElement(property);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Services Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Services Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractServicesElement(AbstractServicesElement object) {
		return null;
	}
