...
public class DataGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ClassElements extends AbstractParserRuleElementFinder {
		...
		//
		//	("description:" description=EString)? ("icon:" icon=STRING)? ("extends" extends+=[ecore::EClass|FQN] (","
		//
		//	extends+=[ecore::EClass|FQN])*)? ("superClass" Inheritences+=AbstractSuperClass (","
		//
	...
	public class LocalClassAssociationElements extends AbstractParserRuleElementFinder {
		...
		//
		//	("description" description=EString ",")? type=Association_Types cardinality=Cardinalities
		//
		//	LocalTarget=[vpdesc::Class|FQN] (("changeable:" changeable=EBoolean)? & ("derived:" derived=EBoolean)? & ("ordered:"
		//
		//	ordered=EBoolean)? & ("transient:" transient=EBoolean)? & ("unique:" unique=EBoolean)? & ("unsettable:"
		//
		//	unsettable=EBoolean)? & ("volatile:" volatile=EBoolean)?) owned_annotations+=Annotation*;
		public ParserRule getRule() { return rule; }
	...
	public class ExternalClassAssociationElements extends AbstractParserRuleElementFinder {
		...
		//
		//	("description" description=EString ",")? type=Association_Types cardinality=Cardinalities "external"
		//
		//	ExternalTarget=[ecore::EClass|FQN] (("changeable:" changeable=EBoolean)? & ("derived:" derived=EBoolean)? &
		//
		//	("ordered:" ordered=EBoolean)? & ("transient:" transient=EBoolean)? & ("unique:" unique=EBoolean)? & ("unsettable:"
		//
		//	unsettable=EBoolean)? & ("volatile:" volatile=EBoolean)?) owned_annotations+=Annotation*;
		public ParserRule getRule() { return rule; }
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		...
		//
		//	("description" description=EString ",")? owned_type=AbstractAttributeType cardinality=Cardinalities? (("id:"
		//
		//	isId=EBoolean)? & ("changeable:" changeable=EBoolean)? & ("derived:" derived=EBoolean)? & ("ordered:"
		//
		//	ordered=EBoolean)? & ("transient:" transient=EBoolean)? & ("unique:" unique=EBoolean)? & ("unsettable:"
		//
		//	unsettable=EBoolean)? & ("volatile:" volatile=EBoolean)?) ("values" "(" (owned_values+=Value (","
		//
		//	owned_values+=Value)*)? ")")? owned_annotations+=Annotation*;
		public ParserRule getRule() { return rule; }
	...
	private DataSpecElements pDataSpec;
	...
	private AbstractSuperClassElements pAbstractSuperClass;
	private LocalSuperClassElements pLocalSuperClass;
	private ExternalSuperClassElements pExternalSuperClass;
	private AbstractFeatureElements pAbstractFeature;
	private AbstractAssociationElements pAbstractAssociation;
	private LocalClassAssociationElements pLocalClassAssociation;
	private ExternalClassAssociationElements pExternalClassAssociation;
	private AbstractAttributeTypeElements pAbstractAttributeType;
	private LocalAttributeTypeElements pLocalAttributeType;
	private ExternalAttributeTypeElements pExternalAttributeType;
	...
	private AnnotatableElementElements pAnnotatableElement;
	private AnnotationElements pAnnotation;
	private DetailElements pDetail;
	private Association_TypesElements unknownRuleAssociation_Types;
	private CardinalitiesElements unknownRuleCardinalities;
	...
	public DataSpecElements getDataSpecAccess() {
		return (pDataSpec != null) ? pDataSpec : (pDataSpec = new DataSpecElements());
	}
	...
	public AbstractSuperClassElements getAbstractSuperClassAccess() {
		return (pAbstractSuperClass != null) ? pAbstractSuperClass : (pAbstractSuperClass = new AbstractSuperClassElements());
	}
	...
	public LocalSuperClassElements getLocalSuperClassAccess() {
		return (pLocalSuperClass != null) ? pLocalSuperClass : (pLocalSuperClass = new LocalSuperClassElements());
	}
	...
	public ExternalSuperClassElements getExternalSuperClassAccess() {
		return (pExternalSuperClass != null) ? pExternalSuperClass : (pExternalSuperClass = new ExternalSuperClassElements());
	}
	...
	public AbstractAssociationElements getAbstractAssociationAccess() {
		return (pAbstractAssociation != null) ? pAbstractAssociation : (pAbstractAssociation = new AbstractAssociationElements());
	}
	...
	public LocalClassAssociationElements getLocalClassAssociationAccess() {
		return (pLocalClassAssociation != null) ? pLocalClassAssociation : (pLocalClassAssociation = new LocalClassAssociationElements());
	}
	...
	public ExternalClassAssociationElements getExternalClassAssociationAccess() {
		return (pExternalClassAssociation != null) ? pExternalClassAssociation : (pExternalClassAssociation = new ExternalClassAssociationElements());
	}
	...
	public AbstractAttributeTypeElements getAbstractAttributeTypeAccess() {
		return (pAbstractAttributeType != null) ? pAbstractAttributeType : (pAbstractAttributeType = new AbstractAttributeTypeElements());
	}
	...
	public LocalAttributeTypeElements getLocalAttributeTypeAccess() {
		return (pLocalAttributeType != null) ? pLocalAttributeType : (pLocalAttributeType = new LocalAttributeTypeElements());
	}
	...
	public ExternalAttributeTypeElements getExternalAttributeTypeAccess() {
		return (pExternalAttributeType != null) ? pExternalAttributeType : (pExternalAttributeType = new ExternalAttributeTypeElements());
	}
	...
	public AnnotatableElementElements getAnnotatableElementAccess() {
		return (pAnnotatableElement != null) ? pAnnotatableElement : (pAnnotatableElement = new AnnotatableElementElements());
	}
	...
	public Association_TypesElements getAssociation_TypesAccess() {
		return (unknownRuleAssociation_Types != null) ? unknownRuleAssociation_Types : (unknownRuleAssociation_Types = new Association_TypesElements());
	}
	...
	public CardinalitiesElements getCardinalitiesAccess() {
		return (unknownRuleCardinalities != null) ? unknownRuleCardinalities : (unknownRuleCardinalities = new CardinalitiesElements());
	}
