...
public class DataSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        DataSpec dataSpec = (DataSpec)theEObject;
        T result = caseDataSpec(dataSpec);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DataPackage.ABSTRACT_IMPORT:
      {
        AbstractImport abstractImport = (AbstractImport)theEObject;
        T result = caseAbstractImport(abstractImport);
        if (result == null) result = caseImport(abstractImport);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DataPackage.IMPORT_NAMESPACE:
      {
        ...
        if (result == null) result = caseImport(importNamespace);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DataPackage.IMPORT_URI:
      {
        ...
        if (result == null) result = caseAbstractImport(importURI);
        if (result == null) result = caseImport(importURI);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DataPackage.IMPORT:
      {
   ...
   * @generated
   */
  public T caseDataSpec(DataSpec object)
  {
    return null;
  }
