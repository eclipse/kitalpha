 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.kitalpha.ad.viewpoint.dsl.as.model.vpdiagram.impl.DiagramChildrenImpl#getSynchronizationMode <em>Synchronization Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DiagramChildrenImpl extends DiagramElementImpl implements
	 ...
	 * @ordered
	 */
	protected static final SynchronizationMode SYNCHRONIZATION_MODE_EDEFAULT = SynchronizationMode.UNSYNCHRONIZABLE;
	/**
	...
	public void setSynchronizationMode(SynchronizationMode newSynchronizationMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VpdiagramPackage.DIAGRAM_CHILDREN__SYNCHRONIZATION_MODE, oldSynchronizationMode, synchronizationMode));
