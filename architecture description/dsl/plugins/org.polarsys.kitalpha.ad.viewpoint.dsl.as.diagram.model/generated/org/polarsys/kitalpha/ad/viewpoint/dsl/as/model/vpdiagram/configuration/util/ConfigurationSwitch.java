...
public class ConfigurationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigurationPackage.DIAGRAM_GENERATION_CONFIGURATION: {
				DiagramGenerationConfiguration diagramGenerationConfiguration = (DiagramGenerationConfiguration)theEObject;
				T result = caseDiagramGenerationConfiguration(diagramGenerationConfiguration);
				if (result == null) result = caseExtensionGeneratrionConfiguration(diagramGenerationConfiguration);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Diagram Generation Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Diagram Generation Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDiagramGenerationConfiguration(DiagramGenerationConfiguration object) {
		return null;
	}
