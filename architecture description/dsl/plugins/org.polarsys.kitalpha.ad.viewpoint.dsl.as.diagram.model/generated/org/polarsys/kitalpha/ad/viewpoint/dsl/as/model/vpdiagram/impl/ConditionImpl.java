...
public class ConditionImpl extends EObjectImpl implements Condition {
	 ...
	 * @ordered
	 */
	protected ForeignExpressionElement expression;
	...
	protected EClass eStaticClass() {
		return VpdiagramPackage.Literals.CONDITION;
	}
	...
	public void setExpression(ForeignExpressionElement newExpression) {
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VpdiagramPackage.CONDITION__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VpdiagramPackage.CONDITION__EXPRESSION, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
			case VpdiagramPackage.CONDITION__EXPRESSION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case VpdiagramPackage.CONDITION__EXPRESSION:
				setExpression((ForeignExpressionElement)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case VpdiagramPackage.CONDITION__EXPRESSION:
				setExpression((ForeignExpressionElement)null);
				return;
		}
