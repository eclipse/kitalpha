...
public class AfdescSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AfdescPackage.ARCHITECTURE_FRAMEWORK: {
				...
				if (result == null) result = caseNamedElement(architectureFramework);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AfdescPackage.ASPECT: {
			...
			case AfdescPackage.NAMED_ELEMENT: {
			...
			case AfdescPackage.CONFIGURATION_ELEMENT: {
			...
			case AfdescPackage.VIEWPOINTS: {
				Viewpoints viewpoints = (Viewpoints)theEObject;
				T result = caseViewpoints(viewpoints);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Viewpoints</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Viewpoints</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseViewpoints(Viewpoints object) {
		return null;
	}
