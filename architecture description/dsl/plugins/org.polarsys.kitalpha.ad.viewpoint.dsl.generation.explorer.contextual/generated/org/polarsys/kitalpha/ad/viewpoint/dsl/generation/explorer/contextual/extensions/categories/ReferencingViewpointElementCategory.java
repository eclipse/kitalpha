...
public class ReferencingViewpointElementCategory extends org.polarsys.kitalpha.ad.viewpoint.dsl.generation.explorer.contextual.common.AbstractCategoryPattern {
	protected static String nl;

	public static synchronized ReferencingViewpointElementCategory create(String lineSeparator) {
		nl = lineSeparator;
		ReferencingViewpointElementCategory result = new ReferencingViewpointElementCategory();
		nl = null;
		return result;
	}
	...
	public ReferencingViewpointElementCategory() {
	...
	protected void method_setCategoryType(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		category = ContextualExplorerCategories.ReferencingViewpointElement;
		InternalPatternContext ictx = (InternalPatternContext) ctx;
