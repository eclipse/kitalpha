...
public class ReferencingViewpointElementJavaClass
  ...
  protected final String TEXT_1 = "\t/**" + NL + "    * <!-- begin-user-doc -->" + NL + "    * <!-- end-user-doc -->"
      + NL + "    * @param object_p: The model element for which the Contextual Explorer extension is generated" + NL
      ...
      + NL + "\t\tResource resource = ((EObject)object_p).eResource();" + NL + "\t\tif (resource != null)" + NL
