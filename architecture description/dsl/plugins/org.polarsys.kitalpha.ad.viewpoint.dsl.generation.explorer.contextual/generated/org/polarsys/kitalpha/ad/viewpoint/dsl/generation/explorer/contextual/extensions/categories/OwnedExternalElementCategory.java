...
public class OwnedExternalElementCategory extends org.polarsys.kitalpha.ad.viewpoint.dsl.generation.explorer.contextual.common.AbstractCategoryPattern {
	protected static String nl;

	public static synchronized OwnedExternalElementCategory create(String lineSeparator) {
		nl = lineSeparator;
