...
public class ParentCategory extends org.polarsys.kitalpha.ad.viewpoint.dsl.generation.explorer.contextual.common.AbstractCategoryPattern {
	protected static String nl;

	public static synchronized ParentCategory create(String lineSeparator) {
		nl = lineSeparator;
		ParentCategory result = new ParentCategory();
		nl = null;
		return result;
	}
