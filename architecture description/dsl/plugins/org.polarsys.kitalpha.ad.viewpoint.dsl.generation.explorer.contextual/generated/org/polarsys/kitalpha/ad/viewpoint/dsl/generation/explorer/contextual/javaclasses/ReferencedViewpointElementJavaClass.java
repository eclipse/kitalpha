...
public class ReferencedViewpointElementJavaClass
		extends
		org.polarsys.kitalpha.ad.viewpoint.dsl.generation.explorer.contextual.common.AbstractAssociationJavaClass {
	protected static String nl;

	public static synchronized ReferencedViewpointElementJavaClass create(
			String lineSeparator) {
		nl = lineSeparator;
		ReferencedViewpointElementJavaClass result = new ReferencedViewpointElementJavaClass();
		nl = null;
		return result;
	}
	...
	protected void method_setJavaClassName(final StringBuffer stringBuffer,
		...
		javaClassName = "ReferencedViewpointElementQuery";
		InternalPatternContext ictx = (InternalPatternContext) ctx;
