...
public class ExternalClassAssociationExternalTargetNotEmptyConstraint extends AbstractTypedElementConstraint {

	@Override
	protected void setEStructuralFeatureName(EObject eObject) {
		eStructuralFeatureName = "ExternalTarget";
	}

	@Override
	protected boolean isObjectInScope(Object object) {
		return object instanceof ExternalClassAssociation;
	}
