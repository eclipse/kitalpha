...
:
(
{ before(grammarAccess.getDiagramsAccess().getImportsImportParserRuleCall_1_0()); }
	ruleImport{ after(grammarAccess.getDiagramsAccess().getImportsImportParserRuleCall_1_0()); }
)
