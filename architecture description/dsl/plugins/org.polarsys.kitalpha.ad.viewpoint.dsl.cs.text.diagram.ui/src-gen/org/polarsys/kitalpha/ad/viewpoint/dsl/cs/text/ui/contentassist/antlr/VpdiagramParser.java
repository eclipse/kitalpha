		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getColorCustomizationAccess().getGroup_4(), "rule__ColorCustomization__Group_4__0");
					put(grammarAccess.getColorCustomizationAccess().getGroup_4_1(), "rule__ColorCustomization__Group_4_1__0");
					...
					put(grammarAccess.getColorCustomizationAccess().getAppliedOnAssignment_4_0(), "rule__ColorCustomization__AppliedOnAssignment_4_0");
					put(grammarAccess.getColorCustomizationAccess().getAppliedOnAssignment_4_1_1(), "rule__ColorCustomization__AppliedOnAssignment_4_1_1");
					put(grammarAccess.getColorCustomizationAccess().getApplyonAllAssignment_6(), "rule__ColorCustomization__ApplyonAllAssignment_6");
					put(grammarAccess.getColorCustomizationAccess().getColorAssignment_7_1(), "rule__ColorCustomization__ColorAssignment_7_1");
