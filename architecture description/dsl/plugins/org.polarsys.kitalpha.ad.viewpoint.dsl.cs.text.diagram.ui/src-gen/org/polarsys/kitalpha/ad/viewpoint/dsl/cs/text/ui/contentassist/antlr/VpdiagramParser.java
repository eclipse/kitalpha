		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_3(), "rule__EdgeStyleCustomization__Group_3__0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_3_1(), "rule__EdgeStyleCustomization__Group_3_1__0");
					...
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_11_4(), "rule__EdgeStyleCustomization__Group_11_4__0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_11_4_1(), "rule__EdgeStyleCustomization__Group_11_4_1__0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_12(), "rule__EdgeStyleCustomization__Group_12__0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_12_4(), "rule__EdgeStyleCustomization__Group_12_4__0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_12_4_1(), "rule__EdgeStyleCustomization__Group_12_4_1__0");
					...
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_17(), "rule__EdgeStyleCustomization__Group_17__0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getGroup_18(), "rule__EdgeStyleCustomization__Group_18__0");
					...
					put(grammarAccess.getColorCustomizationAccess().getGroup_6(), "rule__ColorCustomization__Group_6__0");
					put(grammarAccess.getColorCustomizationAccess().getGroup_7(), "rule__ColorCustomization__Group_7__0");
					put(grammarAccess.getColorCustomizationAccess().getGroup_8(), "rule__ColorCustomization__Group_8__0");
					put(grammarAccess.getLabelCustomizationAccess().getGroup(), "rule__LabelCustomization__Group__0");
					put(grammarAccess.getLabelCustomizationAccess().getGroup_3(), "rule__LabelCustomization__Group_3__0");
					put(grammarAccess.getLabelCustomizationAccess().getGroup_3_1(), "rule__LabelCustomization__Group_3_1__0");
					...
					put(grammarAccess.getLabelCustomizationAccess().getGroup_11(), "rule__LabelCustomization__Group_11__0");
					put(grammarAccess.getLabelCustomizationAccess().getGroup_12(), "rule__LabelCustomization__Group_12__0");
					...
					put(grammarAccess.getContainerStyleCustomizationAccess().getGroup_3(), "rule__ContainerStyleCustomization__Group_3__0");
					put(grammarAccess.getContainerStyleCustomizationAccess().getGroup_3_1(), "rule__ContainerStyleCustomization__Group_3_1__0");
					...
					put(grammarAccess.getContainerStyleCustomizationAccess().getGroup_10(), "rule__ContainerStyleCustomization__Group_10__0");
					put(grammarAccess.getContainerStyleCustomizationAccess().getGroup_11(), "rule__ContainerStyleCustomization__Group_11__0");
					...
					put(grammarAccess.getNodeStyleCustomizationAccess().getGroup_3(), "rule__NodeStyleCustomization__Group_3__0");
					put(grammarAccess.getNodeStyleCustomizationAccess().getGroup_3_1(), "rule__NodeStyleCustomization__Group_3_1__0");
					...
					put(grammarAccess.getNodeStyleCustomizationAccess().getGroup_11(), "rule__NodeStyleCustomization__Group_11__0");
					put(grammarAccess.getNodeStyleCustomizationAccess().getGroup_12(), "rule__NodeStyleCustomization__Group_12__0");
					...
					put(grammarAccess.getEdgeStyleCustomizationAccess().getAppliedOnAssignment_3_0(), "rule__EdgeStyleCustomization__AppliedOnAssignment_3_0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getAppliedOnAssignment_3_1_1(), "rule__EdgeStyleCustomization__AppliedOnAssignment_3_1_1");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getApplyonAllAssignment_6_4(), "rule__EdgeStyleCustomization__ApplyonAllAssignment_6_4");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getSourceArrowAssignment_7_2(), "rule__EdgeStyleCustomization__SourceArrowAssignment_7_2");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getTargetArrowAssignment_8_2(), "rule__EdgeStyleCustomization__TargetArrowAssignment_8_2");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getRoutingStyleAssignment_9_2(), "rule__EdgeStyleCustomization__RoutingStyleAssignment_9_2");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getFoldingStyleAssignment_10_2(), "rule__EdgeStyleCustomization__FoldingStyleAssignment_10_2");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getCenteredSourceMappingsAssignment_11_4_0(), "rule__EdgeStyleCustomization__CenteredSourceMappingsAssignment_11_4_0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getCenteredSourceMappingsAssignment_11_4_1_1(), "rule__EdgeStyleCustomization__CenteredSourceMappingsAssignment_11_4_1_1");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getCenteredTargetMappingsAssignment_12_4_0(), "rule__EdgeStyleCustomization__CenteredTargetMappingsAssignment_12_4_0");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getCenteredTargetMappingsAssignment_12_4_1_1(), "rule__EdgeStyleCustomization__CenteredTargetMappingsAssignment_12_4_1_1");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getBeginLabelStyleDescriptionAssignment_13_5(), "rule__EdgeStyleCustomization__BeginLabelStyleDescriptionAssignment_13_5");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getCenterLabelStyleDescriptionAssignment_14_5(), "rule__EdgeStyleCustomization__CenterLabelStyleDescriptionAssignment_14_5");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getEndLabelStyleDescriptionAssignment_15_5(), "rule__EdgeStyleCustomization__EndLabelStyleDescriptionAssignment_15_5");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getLineStyleAssignment_16_3(), "rule__EdgeStyleCustomization__LineStyleAssignment_16_3");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getSizeComputationExpressionAssignment_17_2(), "rule__EdgeStyleCustomization__SizeComputationExpressionAssignment_17_2");
					put(grammarAccess.getEdgeStyleCustomizationAccess().getEndCenteringAssignment_18_3(), "rule__EdgeStyleCustomization__EndCenteringAssignment_18_3");
					put(grammarAccess.getColorCustomizationAccess().getAppliedOnAssignment_3_0(), "rule__ColorCustomization__AppliedOnAssignment_3_0");
					put(grammarAccess.getColorCustomizationAccess().getAppliedOnAssignment_3_1_1(), "rule__ColorCustomization__AppliedOnAssignment_3_1_1");
					put(grammarAccess.getColorCustomizationAccess().getApplyonAllAssignment_6_4(), "rule__ColorCustomization__ApplyonAllAssignment_6_4");
					put(grammarAccess.getColorCustomizationAccess().getColorAssignment_7_2(), "rule__ColorCustomization__ColorAssignment_7_2");
					put(grammarAccess.getColorCustomizationAccess().getColorUseCaseAssignment_8_4(), "rule__ColorCustomization__ColorUseCaseAssignment_8_4");
					put(grammarAccess.getLabelCustomizationAccess().getAppliedOnAssignment_3_0(), "rule__LabelCustomization__AppliedOnAssignment_3_0");
					put(grammarAccess.getLabelCustomizationAccess().getAppliedOnAssignment_3_1_1(), "rule__LabelCustomization__AppliedOnAssignment_3_1_1");
					put(grammarAccess.getLabelCustomizationAccess().getApplyonAllAssignment_6_4(), "rule__LabelCustomization__ApplyonAllAssignment_6_4");
					put(grammarAccess.getLabelCustomizationAccess().getOwnedLabelAlignmentAssignment_7(), "rule__LabelCustomization__OwnedLabelAlignmentAssignment_7");
					put(grammarAccess.getLabelCustomizationAccess().getSizeAssignment_8_2(), "rule__LabelCustomization__SizeAssignment_8_2");
					put(grammarAccess.getLabelCustomizationAccess().getFormatAssignment_9_2(), "rule__LabelCustomization__FormatAssignment_9_2");
					put(grammarAccess.getLabelCustomizationAccess().getColorAssignment_10_2(), "rule__LabelCustomization__ColorAssignment_10_2");
					put(grammarAccess.getLabelCustomizationAccess().getShowIconAssignment_11_4(), "rule__LabelCustomization__ShowIconAssignment_11_4");
					put(grammarAccess.getLabelCustomizationAccess().getIconPathAssignment_11_7(), "rule__LabelCustomization__IconPathAssignment_11_7");
					put(grammarAccess.getLabelCustomizationAccess().getExpressionAssignment_12_2(), "rule__LabelCustomization__ExpressionAssignment_12_2");
					...
					put(grammarAccess.getContainerStyleCustomizationAccess().getAppliedOnAssignment_3_0(), "rule__ContainerStyleCustomization__AppliedOnAssignment_3_0");
					put(grammarAccess.getContainerStyleCustomizationAccess().getAppliedOnAssignment_3_1_1(), "rule__ContainerStyleCustomization__AppliedOnAssignment_3_1_1");
					put(grammarAccess.getContainerStyleCustomizationAccess().getApplyonAllAssignment_6_4(), "rule__ContainerStyleCustomization__ApplyonAllAssignment_6_4");
					put(grammarAccess.getContainerStyleCustomizationAccess().getArcWithAssignment_7_2(), "rule__ContainerStyleCustomization__ArcWithAssignment_7_2");
					put(grammarAccess.getContainerStyleCustomizationAccess().getArcHeightAssignment_8_2(), "rule__ContainerStyleCustomization__ArcHeightAssignment_8_2");
					put(grammarAccess.getContainerStyleCustomizationAccess().getRoundedCornerAssignment_9_3(), "rule__ContainerStyleCustomization__RoundedCornerAssignment_9_3");
					put(grammarAccess.getContainerStyleCustomizationAccess().getTooltipExpressionAssignment_10_3(), "rule__ContainerStyleCustomization__TooltipExpressionAssignment_10_3");
					put(grammarAccess.getContainerStyleCustomizationAccess().getBorderSizeComputationExpressionAssignment_11_3(), "rule__ContainerStyleCustomization__BorderSizeComputationExpressionAssignment_11_3");
					put(grammarAccess.getContainerStyleCustomizationAccess().getOwnedSpecificContainerStyleCustomizationAssignment_12(), "rule__ContainerStyleCustomization__OwnedSpecificContainerStyleCustomizationAssignment_12");
					...
					put(grammarAccess.getNodeStyleCustomizationAccess().getAppliedOnAssignment_3_0(), "rule__NodeStyleCustomization__AppliedOnAssignment_3_0");
					put(grammarAccess.getNodeStyleCustomizationAccess().getAppliedOnAssignment_3_1_1(), "rule__NodeStyleCustomization__AppliedOnAssignment_3_1_1");
					put(grammarAccess.getNodeStyleCustomizationAccess().getApplyonAllAssignment_6_4(), "rule__NodeStyleCustomization__ApplyonAllAssignment_6_4");
					put(grammarAccess.getNodeStyleCustomizationAccess().getLabelPositionAssignment_7_3(), "rule__NodeStyleCustomization__LabelPositionAssignment_7_3");
					put(grammarAccess.getNodeStyleCustomizationAccess().getHideLabelByDefaultAssignment_8_3(), "rule__NodeStyleCustomization__HideLabelByDefaultAssignment_8_3");
					put(grammarAccess.getNodeStyleCustomizationAccess().getResizeKindAssignment_9_3(), "rule__NodeStyleCustomization__ResizeKindAssignment_9_3");
					put(grammarAccess.getNodeStyleCustomizationAccess().getTooltipExpressionAssignment_10_3(), "rule__NodeStyleCustomization__TooltipExpressionAssignment_10_3");
					put(grammarAccess.getNodeStyleCustomizationAccess().getBorderSizeComputationExpressionAssignment_11_3(), "rule__NodeStyleCustomization__BorderSizeComputationExpressionAssignment_11_3");
					put(grammarAccess.getNodeStyleCustomizationAccess().getSizeComputationExpressionAssignment_12_3(), "rule__NodeStyleCustomization__SizeComputationExpressionAssignment_12_3");
					put(grammarAccess.getNodeStyleCustomizationAccess().getOwnedSpecificNodeStyleCustomizationAssignment_13(), "rule__NodeStyleCustomization__OwnedSpecificNodeStyleCustomizationAssignment_13");
					...
					put(grammarAccess.getLozengeCustomizationAccess().getWidthComputationExpressionAssignment_7(), "rule__LozengeCustomization__WidthComputationExpressionAssignment_7");
					put(grammarAccess.getLozengeCustomizationAccess().getHeightComputationExpressionAssignment_10(), "rule__LozengeCustomization__HeightComputationExpressionAssignment_10");
					put(grammarAccess.getGaugeCustomizationAccess().getAlignementAssignment_4(), "rule__GaugeCustomization__AlignementAssignment_4");
					put(grammarAccess.getEllipseCustomizationAccess().getHorizontalDiameterComputationExpressionAssignment_7(), "rule__EllipseCustomization__HorizontalDiameterComputationExpressionAssignment_7");
					put(grammarAccess.getEllipseCustomizationAccess().getVerticalDiameterComputationExpressionAssignment_10(), "rule__EllipseCustomization__VerticalDiameterComputationExpressionAssignment_10");
					...
					put(grammarAccess.getSquareCustomizationAccess().getWidthAssignment_7(), "rule__SquareCustomization__WidthAssignment_7");
					put(grammarAccess.getSquareCustomizationAccess().getHeightAssignment_10(), "rule__SquareCustomization__HeightAssignment_10");
					put(grammarAccess.getDotCustomizationAccess().getStrokeSizeComputationExpressionAssignment_4(), "rule__DotCustomization__StrokeSizeComputationExpressionAssignment_4");
