		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMappingBasedAccess().getAlternatives_9(), "rule__MappingBased__Alternatives_9");
					...
					put(grammarAccess.getDecorationDistributionDirectionAccess().getAlternatives(), "rule__DecorationDistributionDirection__Alternatives");
					...
					put(grammarAccess.getDecoratorSetAccess().getGroup(), "rule__DecoratorSet__Group__0");
					put(grammarAccess.getBasicAccess().getGroup(), "rule__Basic__Group__0");
					put(grammarAccess.getBasicAccess().getGroup_4(), "rule__Basic__Group_4__0");
					put(grammarAccess.getBasicAccess().getGroup_5(), "rule__Basic__Group_5__0");
					put(grammarAccess.getBasicAccess().getGroup_6(), "rule__Basic__Group_6__0");
					put(grammarAccess.getBasicAccess().getGroup_7(), "rule__Basic__Group_7__0");
					put(grammarAccess.getBasicAccess().getGroup_8(), "rule__Basic__Group_8__0");
					put(grammarAccess.getMappingBasedAccess().getGroup(), "rule__MappingBased__Group__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_4(), "rule__MappingBased__Group_4__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_5(), "rule__MappingBased__Group_5__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_6(), "rule__MappingBased__Group_6__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_7(), "rule__MappingBased__Group_7__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_8(), "rule__MappingBased__Group_8__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_9_0(), "rule__MappingBased__Group_9_0__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_9_0_2(), "rule__MappingBased__Group_9_0_2__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_9_0_2_2(), "rule__MappingBased__Group_9_0_2_2__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_9_0_2_2_1(), "rule__MappingBased__Group_9_0_2_2_1__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_9_0_2_4(), "rule__MappingBased__Group_9_0_2_4__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_9_1(), "rule__MappingBased__Group_9_1__0");
					put(grammarAccess.getMappingBasedAccess().getGroup_9_1_1(), "rule__MappingBased__Group_9_1_1__0");
					put(grammarAccess.getSemanticBasedAccess().getGroup(), "rule__SemanticBased__Group__0");
					put(grammarAccess.getSemanticBasedAccess().getGroup_4(), "rule__SemanticBased__Group_4__0");
					put(grammarAccess.getSemanticBasedAccess().getGroup_5(), "rule__SemanticBased__Group_5__0");
					put(grammarAccess.getSemanticBasedAccess().getGroup_6(), "rule__SemanticBased__Group_6__0");
					put(grammarAccess.getSemanticBasedAccess().getGroup_7(), "rule__SemanticBased__Group_7__0");
					put(grammarAccess.getSemanticBasedAccess().getGroup_8(), "rule__SemanticBased__Group_8__0");
					put(grammarAccess.getSemanticBasedAccess().getGroup_9(), "rule__SemanticBased__Group_9__0");
					...
					put(grammarAccess.getDiagramAccess().getThe_DecoratorSetAssignment_8(), "rule__Diagram__The_DecoratorSetAssignment_8");
					...
					put(grammarAccess.getDiagramExtensionAccess().getThe_DecoratorSetAssignment_7(), "rule__DiagramExtension__The_DecoratorSetAssignment_7");
					put(grammarAccess.getDiagramExtensionAccess().getOwnedCustomizationsAssignment_8(), "rule__DiagramExtension__OwnedCustomizationsAssignment_8");
					...
					put(grammarAccess.getDecoratorSetAccess().getDecoratorsAssignment_3(), "rule__DecoratorSet__DecoratorsAssignment_3");
					put(grammarAccess.getBasicAccess().getNameAssignment_2(), "rule__Basic__NameAssignment_2");
					put(grammarAccess.getBasicAccess().getPositionAssignment_4_1(), "rule__Basic__PositionAssignment_4_1");
					put(grammarAccess.getBasicAccess().getDirectionAssignment_5_1(), "rule__Basic__DirectionAssignment_5_1");
					put(grammarAccess.getBasicAccess().getIconAssignment_6_1(), "rule__Basic__IconAssignment_6_1");
					put(grammarAccess.getBasicAccess().getPreconditionAssignment_7_1(), "rule__Basic__PreconditionAssignment_7_1");
					put(grammarAccess.getBasicAccess().getTooltipAssignment_8_1(), "rule__Basic__TooltipAssignment_8_1");
					put(grammarAccess.getMappingBasedAccess().getNameAssignment_2(), "rule__MappingBased__NameAssignment_2");
					put(grammarAccess.getMappingBasedAccess().getPositionAssignment_4_1(), "rule__MappingBased__PositionAssignment_4_1");
					put(grammarAccess.getMappingBasedAccess().getDirectionAssignment_5_1(), "rule__MappingBased__DirectionAssignment_5_1");
					put(grammarAccess.getMappingBasedAccess().getIconAssignment_6_1(), "rule__MappingBased__IconAssignment_6_1");
					put(grammarAccess.getMappingBasedAccess().getPreconditionAssignment_7_1(), "rule__MappingBased__PreconditionAssignment_7_1");
					put(grammarAccess.getMappingBasedAccess().getTooltipAssignment_8_1(), "rule__MappingBased__TooltipAssignment_8_1");
					put(grammarAccess.getMappingBasedAccess().getExternalMappingsAssignment_9_0_2_2_0(), "rule__MappingBased__ExternalMappingsAssignment_9_0_2_2_0");
					put(grammarAccess.getMappingBasedAccess().getExternalMappingsAssignment_9_0_2_2_1_1(), "rule__MappingBased__ExternalMappingsAssignment_9_0_2_2_1_1");
					put(grammarAccess.getMappingBasedAccess().getInternalMappingsAssignment_9_0_2_4_1(), "rule__MappingBased__InternalMappingsAssignment_9_0_2_4_1");
					put(grammarAccess.getMappingBasedAccess().getInternalMappingsAssignment_9_1_0(), "rule__MappingBased__InternalMappingsAssignment_9_1_0");
					put(grammarAccess.getMappingBasedAccess().getInternalMappingsAssignment_9_1_1_1(), "rule__MappingBased__InternalMappingsAssignment_9_1_1_1");
					put(grammarAccess.getSemanticBasedAccess().getNameAssignment_2(), "rule__SemanticBased__NameAssignment_2");
					put(grammarAccess.getSemanticBasedAccess().getPositionAssignment_4_1(), "rule__SemanticBased__PositionAssignment_4_1");
					put(grammarAccess.getSemanticBasedAccess().getDirectionAssignment_5_1(), "rule__SemanticBased__DirectionAssignment_5_1");
					put(grammarAccess.getSemanticBasedAccess().getIconAssignment_6_1(), "rule__SemanticBased__IconAssignment_6_1");
					put(grammarAccess.getSemanticBasedAccess().getPreconditionAssignment_7_1(), "rule__SemanticBased__PreconditionAssignment_7_1");
					put(grammarAccess.getSemanticBasedAccess().getTooltipAssignment_8_1(), "rule__SemanticBased__TooltipAssignment_8_1");
					put(grammarAccess.getSemanticBasedAccess().getDomainAssignment_9_1(), "rule__SemanticBased__DomainAssignment_9_1");
