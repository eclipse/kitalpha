...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.af.dsl.as.model.afdesc.Configuration} object.
 * <!-- begin-user-doc -->
...
public class ConfigurationItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AfdescPackage.Literals.CONFIGURATION__OWNED_ELEMENT);
		}
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
				...
				newChildDescriptors.add
					(createChildParameter
						(AfdescPackage.Literals.CONFIGURATION__OWNED_ELEMENT,
						 AfdescFactory.eINSTANCE.createGenerationConfiguration()));
