...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.af.dsl.as.model.afdesc.NamedElement} object.
 * <!-- begin-user-doc -->
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AfdescPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AfdescPackage.Literals.NAMED_ELEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addShortNamePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_shortName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_shortName_feature", "_UI_NamedElement_type"),
				 AfdescPackage.Literals.NAMED_ELEMENT__SHORT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
