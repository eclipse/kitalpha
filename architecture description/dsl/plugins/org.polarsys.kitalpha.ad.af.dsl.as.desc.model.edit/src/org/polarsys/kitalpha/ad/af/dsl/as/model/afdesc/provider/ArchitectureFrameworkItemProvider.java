...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.af.dsl.as.model.afdesc.ArchitectureFramework} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchitectureFrameworkItemProvider extends NamedElementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AfdescPackage.Literals.ARCHITECTURE_FRAMEWORK__AF_ASPECTS);
			childrenFeatures.add(AfdescPackage.Literals.ARCHITECTURE_FRAMEWORK__AF_VIEWPOINTS);
			childrenFeatures.add(AfdescPackage.Literals.ARCHITECTURE_FRAMEWORK__OWNED_CONFIGURATION);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add
			(createChildParameter
				(AfdescPackage.Literals.ARCHITECTURE_FRAMEWORK__AF_VIEWPOINTS,
				 AfdescFactory.eINSTANCE.createViewpoints()));
		...
		newChildDescriptors.add
			(createChildParameter
				(AfdescPackage.Literals.ARCHITECTURE_FRAMEWORK__OWNED_CONFIGURATION,
				 AfdescFactory.eINSTANCE.createConfiguration()));
