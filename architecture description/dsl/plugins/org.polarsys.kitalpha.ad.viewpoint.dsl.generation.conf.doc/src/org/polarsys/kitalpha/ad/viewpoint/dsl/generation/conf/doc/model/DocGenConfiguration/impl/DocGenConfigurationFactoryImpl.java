...
public class DocGenConfigurationFactoryImpl extends EFactoryImpl implements DocGenConfigurationFactory {
	...
	public static DocGenConfigurationFactory init() {
		try {
			DocGenConfigurationFactory theDocGenConfigurationFactory = (DocGenConfigurationFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.polarsys.org/kitalpha/ad/viewpoint/dsl/DocGenConfiguration/1.0.0"); 
