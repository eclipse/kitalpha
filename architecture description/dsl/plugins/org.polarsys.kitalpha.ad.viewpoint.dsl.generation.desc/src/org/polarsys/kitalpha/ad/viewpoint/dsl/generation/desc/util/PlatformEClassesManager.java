...
//		Old code
//		return (resource != null ? (EEnum)((EPackage)resource.getContents().get(0)).getEClassifier(eenum.getName()) : null);
	}
	...
	public EClass getEClassesWithPlatformURI(EClass clazz){
		...
		return clazz;
		//return (resource != null ? (EClass)((EPackage)resource.getContents().get(0)).getEClassifier(clazz.getName()) : null);
	}
