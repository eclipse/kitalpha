...
public class PagePredicateJavaClass extends
  ...
  protected final String TEXT_3 = "() {" + NL + "\t\t// TODO Auto-generated constructor stub" + NL + "\t}" + NL + ""
      + NL + "\t/**" + NL + "\t * @generated " + NL + "\t */" + NL + "\t@Override" + NL + "\tpublic boolean isOk() {";
  ...
  protected final String TEXT_9 = "\t" + NL + "\t/**" + NL + "\t * User predicate implementation" + NL
      ...
      + "\tprivate boolean userPredicate(){" + NL + "\t\t// TODO: implement this method to provide the user predicate"
      + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\treturn true;" + NL
      + "\t}";
  protected final String TEXT_10 = "\t" + NL + "\t/**" + NL
      ...
      + "\t * @return True if the current page can be used with the current resource. " + NL + "\t * @generated" + NL
      + "\t */" + NL + "\tprotected boolean fileExtensionPredicate(){" + NL
