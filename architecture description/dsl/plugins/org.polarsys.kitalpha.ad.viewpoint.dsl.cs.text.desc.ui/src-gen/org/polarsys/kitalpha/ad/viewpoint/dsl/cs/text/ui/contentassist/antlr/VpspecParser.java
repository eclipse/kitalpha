		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getViewpointAccess().getVP_DataAssignment_8_1(), "rule__Viewpoint__VP_DataAssignment_8_1");
					put(grammarAccess.getViewpointAccess().getTypeAssignment_9_0(), "rule__Viewpoint__TypeAssignment_9_0");
					put(grammarAccess.getViewpointAccess().getVP_AspectsAssignment_9_1(), "rule__Viewpoint__VP_AspectsAssignment_9_1");
					put(grammarAccess.getViewpointAccess().getTypeAssignment_10_0(), "rule__Viewpoint__TypeAssignment_10_0");
					put(grammarAccess.getViewpointAccess().getVP_AspectsAssignment_10_1(), "rule__Viewpoint__VP_AspectsAssignment_10_1");
					put(grammarAccess.getViewpointAccess().getTypeAssignment_11_0(), "rule__Viewpoint__TypeAssignment_11_0");
					put(grammarAccess.getViewpointAccess().getVP_AspectsAssignment_11_1(), "rule__Viewpoint__VP_AspectsAssignment_11_1");
