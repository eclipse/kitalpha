		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getViewpointAccess().getUseEcoreResourceAssignment_9_1(), "rule__Viewpoint__UseEcoreResourceAssignment_9_1");
					put(grammarAccess.getViewpointAccess().getUseResourceAssignment_9_2_1(), "rule__Viewpoint__UseResourceAssignment_9_2_1");
					...
					put(grammarAccess.getViewpointAccess().getUseResourceAssignment_10_2_1(), "rule__Viewpoint__UseResourceAssignment_10_2_1");
					put(grammarAccess.getViewpointAccess().getUseEMFResourceAssignment_11_1(), "rule__Viewpoint__UseEMFResourceAssignment_11_1");
					put(grammarAccess.getViewpointAccess().getUseResourceAssignment_11_2_1(), "rule__Viewpoint__UseResourceAssignment_11_2_1");
					put(grammarAccess.getViewpointAccess().getVP_DataAssignment_12_1(), "rule__Viewpoint__VP_DataAssignment_12_1");
