...
public interface GenerationConfigurationConstants {
	...
	public static final String GEN_CONF_EXTENSION_ID = 
	...
	public static final String GEN_CONF_INNER_CONFIGURATION_ELEMENT_NAME = "inner"; //$NON-NLS-1$
	
	/** Generation configuration extension point class attribute **/
	public static final String GEN_CONF_ATTRIBUTE_CLASS = "class"; //$NON-NLS-1$
}
