...
public class VpuiGrammarAccess extends AbstractGrammarElementFinder {
	...
	private UserInterfaceElements pUserInterface;
	private ImportElements pImport;
	private AspectElements pAspect;
	private UIDescriptionElements pUIDescription;
	private DisplayableElementElements pDisplayableElement;
	private UIElements pUI;
	private UIContainerElements pUIContainer;
	private DataSourceElements pDataSource;
	private LocalClassElements pLocalClass;
	private UIFieldElements pUIField;
	private FieldMappingElements pFieldMapping;
	private UI_Field_TypeElements unknownRuleUI_Field_Type;
	...
	public UserInterfaceElements getUserInterfaceAccess() {
		return (pUserInterface != null) ? pUserInterface : (pUserInterface = new UserInterfaceElements());
	}
	...
	public UIDescriptionElements getUIDescriptionAccess() {
		return (pUIDescription != null) ? pUIDescription : (pUIDescription = new UIDescriptionElements());
	}
	...
	public DisplayableElementElements getDisplayableElementAccess() {
		return (pDisplayableElement != null) ? pDisplayableElement : (pDisplayableElement = new DisplayableElementElements());
	}
	...
	public UIElements getUIAccess() {
		return (pUI != null) ? pUI : (pUI = new UIElements());
	}
	...
	public UIContainerElements getUIContainerAccess() {
		return (pUIContainer != null) ? pUIContainer : (pUIContainer = new UIContainerElements());
	}
	...
	public LocalClassElements getLocalClassAccess() {
		return (pLocalClass != null) ? pLocalClass : (pLocalClass = new LocalClassElements());
	}
	...
	public FieldMappingElements getFieldMappingAccess() {
		return (pFieldMapping != null) ? pFieldMapping : (pFieldMapping = new FieldMappingElements());
	}
	...
	public UI_Field_TypeElements getUI_Field_TypeAccess() {
		return (unknownRuleUI_Field_Type != null) ? unknownRuleUI_Field_Type : (unknownRuleUI_Field_Type = new UI_Field_TypeElements());
	}
