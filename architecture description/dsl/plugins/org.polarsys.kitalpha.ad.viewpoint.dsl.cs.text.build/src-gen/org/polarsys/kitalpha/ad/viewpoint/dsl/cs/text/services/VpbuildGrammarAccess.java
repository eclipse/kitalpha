...
public class VpbuildGrammarAccess extends AbstractGrammarElementFinder {
	...
	private BuildElements pBuild;
	private RepositoryElements pRepository;
	private SourceFoulderElements pSourceFoulder;
	private HudsonDeploymentElements pHudsonDeployment;
	private GenerationLocationElements pGenerationLocation;
	private TriggerElements pTrigger;
	private SCMElements pSCM;
	private CronElements pCron;
	private UserElements pUser;
	private ProtocolTypeElements unknownRuleProtocolType;
	private UserPermissionElements unknownRuleUserPermission;
	...
	public BuildElements getBuildAccess() {
		return (pBuild != null) ? pBuild : (pBuild = new BuildElements());
	}
	...
	public SourceFoulderElements getSourceFoulderAccess() {
		return (pSourceFoulder != null) ? pSourceFoulder : (pSourceFoulder = new SourceFoulderElements());
	}
	...
	public HudsonDeploymentElements getHudsonDeploymentAccess() {
		return (pHudsonDeployment != null) ? pHudsonDeployment : (pHudsonDeployment = new HudsonDeploymentElements());
	}
	...
	public GenerationLocationElements getGenerationLocationAccess() {
		return (pGenerationLocation != null) ? pGenerationLocation : (pGenerationLocation = new GenerationLocationElements());
	}
	...
	public SCMElements getSCMAccess() {
		return (pSCM != null) ? pSCM : (pSCM = new SCMElements());
	}
	...
	public CronElements getCronAccess() {
		return (pCron != null) ? pCron : (pCron = new CronElements());
	}
	...
	public ProtocolTypeElements getProtocolTypeAccess() {
		return (unknownRuleProtocolType != null) ? unknownRuleProtocolType : (unknownRuleProtocolType = new ProtocolTypeElements());
	}
	...
	public UserPermissionElements getUserPermissionAccess() {
		return (unknownRuleUserPermission != null) ? unknownRuleUserPermission : (unknownRuleUserPermission = new UserPermissionElements());
	}
