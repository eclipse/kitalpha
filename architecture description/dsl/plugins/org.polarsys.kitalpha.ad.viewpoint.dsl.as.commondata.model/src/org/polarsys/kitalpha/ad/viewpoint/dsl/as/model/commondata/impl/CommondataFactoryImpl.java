...
public class CommondataFactoryImpl extends EFactoryImpl implements
	...
	public static CommondataFactory init() {
		try {
			CommondataFactory theCommondataFactory = (CommondataFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.polarsys.org/kitalpha/ad/viewpoint/dsl/as/commondata/1.0.0"); 
