...
import org.polarsys.kitalpha.ad.viewpoint.coredomain.viewpoint.tools.model.*;
 ...
 * <!-- end-user-doc -->
 * @see org.polarsys.kitalpha.ad.viewpoint.coredomain.viewpoint.tools.model.ToolsPackage
 * @generated
 */
public class ToolsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ToolsPackage.VIEWPOINT_ELEMENT: {
				ViewpointElement viewpointElement = (ViewpointElement)theEObject;
				T result = caseViewpointElement(viewpointElement);
				if (result == null) result = caseNameElement(viewpointElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ToolsPackage.VIEWPOINT_ELEMENT_SET: {
				ViewpointElementSet viewpointElementSet = (ViewpointElementSet)theEObject;
				T result = caseViewpointElementSet(viewpointElementSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
