...
public class MetamodelImpl extends EObjectImpl implements Metamodel {
	 ...
	 * @ordered
	 */
	protected EList<EPackage> models;
	...
	protected EClass eStaticClass() {
		return ViewpointPackage.Literals.METAMODEL;
	}
	...
	public EList<EPackage> getModels() {

		if (models == null) {
			models = new EObjectResolvingEList<EPackage>(EPackage.class, this, ViewpointPackage.METAMODEL__MODELS);
		}
		return models;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ViewpointPackage.METAMODEL__MODELS:
				return getModels();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ViewpointPackage.METAMODEL__MODELS:
				getModels().clear();
				getModels().addAll((Collection<? extends EPackage>)newValue);
				return;
		}
