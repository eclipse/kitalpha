...
package org.polarsys.kitalpha.ad.af.coredomain.patterns.labelproviders;
...
public class getTextPattern extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	...
	protected final String TEXT_1 = NL + "\t\tif (object instanceof NameElement) {" + NL + "\t\t\tNameElement elt = (NameElement) object;" + NL + "\t\t\tString label = elt.getName();" + NL
			+ "\t\t\tif (label == null)" + NL + "\t\t\t\tlabel = \"\";" + NL + "\t\t\tString id = elt.getId();" + NL + "\t\t\tif (id == null)" + NL + "\t\t\t\tid = \"no ID\";" + NL
			+ "\t\t\tlabel = elt.eClass().getName() + \" [\" + id + \"] \" + label;" + NL + "\t\t\treturn label;" + NL + "\t\t}" + NL + "\t\treturn ((EObject) object).eClass().getName();" + NL;
