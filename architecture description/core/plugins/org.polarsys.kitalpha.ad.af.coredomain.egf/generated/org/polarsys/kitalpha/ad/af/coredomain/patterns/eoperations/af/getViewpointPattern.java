...
public class getViewpointPattern
  ...
  public static synchronized getViewpointPattern create(String lineSeparator) {
    nl = lineSeparator;
    getViewpointPattern result = new getViewpointPattern();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "\t\tfor (Viewpoint vp : getViewpoints()) {" + NL + "\t\t\tif (id.equals(vp.getId()))"
      + NL + "\t\t\t\treturn vp;" + NL + "\t\t}" + NL + "\t\treturn null;";
  protected final String TEXT_2 = NL;

  public getViewpointPattern() {
  ...
  public boolean preCondition(PatternContext ctx) throws Exception {
    ...
    return "getViewpoint".equals(operation) && "AF".equals(cls);
