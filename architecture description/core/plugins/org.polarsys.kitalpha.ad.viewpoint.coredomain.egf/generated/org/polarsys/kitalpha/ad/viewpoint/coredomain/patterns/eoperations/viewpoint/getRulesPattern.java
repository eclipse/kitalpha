...
public class getRulesPattern extends org.eclipse.egf.emf.pattern.model.call.Class.ClassimplementedGenOperationTODOoverride {
	...
	public static synchronized getRulesPattern create(String lineSeparator) {
		nl = lineSeparator;
		getRulesPattern result = new getRulesPattern();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = NL + "\t\tBasicEList<Rule> rules = new BasicEList<Rule>();" + NL + "\t\tMap<String, Rule> collector = new HashMap<String, Rule>();" + NL
			+ "\t\tcollectRules(collector);" + NL + "\t\trules.addAll(collector.values());" + NL + "\t\treturn rules;";

	protected final String TEXT_2 = NL;

	public getRulesPattern() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		...
		return "getRules".equals(operation) && "Viewpoint".equals(cls);
