...
public class insertOperationPattern extends org.eclipse.egf.emf.pattern.model.call.Class.Classinsert {
  ...
  protected final String TEXT_1 = NL + NL + "\tprotected void collectProperties(Map<String, Property> name2prop) {" + NL
      + "\t\tfor (Viewpoint vp : getParents())" + NL + "\t\t\t((ViewpointImpl) vp).collectProperties(name2prop);" + NL
      + "\t\tif (getPropertySet() != null) {" + NL + "\t\t\tfor (Property prop : getPropertySet().getNewProperties())"
      + NL + "\t\t\t\tname2prop.put(prop.getName(), prop);" + NL
      + "\t\t\tfor (Property prop : getPropertySet().getHiddenProperties())" + NL
      + "\t\t\t\tname2prop.remove(prop.getName());" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL
      + "\tprotected void collectRules(Map<String, Rule> rules) {" + NL + "\t\tfor (Viewpoint vp : getParents())" + NL
      + "\t\t\t((ViewpointImpl) vp).collectRules(rules);" + NL + "\t\tif (getRuleSet() != null) {" + NL
      + "\t\t\taddElements(rules, getRuleSet().getNewRules());" + NL
      + "\t\t\tremoveElements(rules, (getRuleSet().getHiddenRules()));" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL
      + "\tprotected void collectServices(Map<String, Service> services) {" + NL
      + "\t\tfor (Viewpoint vp : getParents())" + NL + "\t\t\t((ViewpointImpl) vp).collectServices(services);" + NL
      + "\t\tif (getServiceSet() != null) {" + NL + "\t\t\taddElements(services, getServiceSet().getNewServices());"
      + NL + "\t\t\tremoveElements(services, getServiceSet().getHiddenServices());" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_2 = NL + NL
      ...
      + "\t\tfor (T elt : elts) {" + NL + "\t\t\tcollector.remove(elt.getId());" + NL + "\t\t}" + NL + "\t}" + NL + NL;
