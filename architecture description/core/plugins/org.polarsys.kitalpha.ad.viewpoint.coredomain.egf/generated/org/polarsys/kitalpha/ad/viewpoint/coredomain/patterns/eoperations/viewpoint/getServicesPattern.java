...
public class getServicesPattern
  ...
  protected final String TEXT_1 = "\t\tBasicEList<Service> services = new BasicEList<Service>();" + NL
      + "\t\tMap<String, Service> collector = new HashMap<String, Service>();" + NL + "\t\tcollectServices(collector);"
      + NL + "\t\tservices.addAll(collector.values());" + NL + "\t\treturn services;";
