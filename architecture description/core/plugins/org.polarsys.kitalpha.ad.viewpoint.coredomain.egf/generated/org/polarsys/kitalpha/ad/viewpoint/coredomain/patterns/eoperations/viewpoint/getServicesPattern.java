...
public class getServicesPattern extends org.eclipse.egf.emf.pattern.model.call.Class.ClassimplementedGenOperationTODOoverride {
	protected static String nl;

	public static synchronized getServicesPattern create(String lineSeparator) {
		nl = lineSeparator;
		getServicesPattern result = new getServicesPattern();
		nl = null;
		return result;
	}

	public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	protected final String TEXT_1 = "\t\tBasicEList<Service> services = new BasicEList<Service>();" + NL + "\t\tMap<String, Service> collector = new HashMap<String, Service>();" + NL + "\t\tcollectServices(collector);" + NL + "\t\tservices.addAll(collector.values());" + NL + "\t\treturn services;";
	protected final String TEXT_2 = NL;
	protected final String TEXT_3 = NL;

	public getServicesPattern() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		...
		return "getServices".equals(operation) && "Viewpoint".equals(cls);
