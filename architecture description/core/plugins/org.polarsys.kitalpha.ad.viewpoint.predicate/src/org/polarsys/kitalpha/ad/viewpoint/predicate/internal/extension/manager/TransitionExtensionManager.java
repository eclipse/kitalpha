...
public class TransitionExtensionManager extends AbstractExtensionManager {
	...
	private final static TransitionExtensionManager INSTANCE = new TransitionExtensionManager();
	
	public synchronized static TransitionExtensionManager getInstance(){
		return INSTANCE;
	}
