...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.ad.viewpoint.coredomain.viewpoint.model.ValidationRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValidationRule_severity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_severity_feature", "_UI_ValidationRule_type"),
				 ViewpointPackage.Literals.VALIDATION_RULE__SEVERITY,
				 true,
				 false,
				 false,
	...
	protected void addMessagePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValidationRule_message_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_message_feature", "_UI_ValidationRule_type"),
				 ViewpointPackage.Literals.VALIDATION_RULE__MESSAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
