...
public class BAdapterFactory extends AdapterFactoryImpl {
	...
	protected BSwitch<Adapter> modelSwitch = new BSwitch<Adapter>() {
		...
		@Override
		public Adapter caseAChlid(AChlid object) {
			return createAChlidAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link B.B.BChild <em>Child</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link A.A.AChlid <em>Chlid</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAChlidAdapter() {
		return null;
	}
