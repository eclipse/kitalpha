...
public class ModelTests4 extends ModelTests {
	...
	public void testManager6() throws Exception {
		...
		assertEquals("Expecting version '0.0.0' for viewpoint 'org.polarsys.kitalpha.vp.componentsampleperformance' (current version: '1.3.3.qualifier')", result.getChildren()[0].getMessage());
	}
