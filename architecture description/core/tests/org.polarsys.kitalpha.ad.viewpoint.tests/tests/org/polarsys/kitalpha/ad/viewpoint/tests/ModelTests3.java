...
public class ModelTests3 extends ModelTests {
	...
	public void testManager6() throws Exception {
		...
		assertEquals("The viewpoint 'org.polarsys.kitalpha.vp.componentsampleperformance' is needed in incompatible versions :1.1.0.qualifier / 1.0.0.qualifier", result.getChildren()[0].getMessage());
	}
