...
public class ModelTests3 extends ModelTests {
	...
	public void testManager6() throws Exception {
		...
		assertEquals("The viewpoint 'org.polarsys.kitalpha.vp.componentsampleperformance' is needed in incompatible versions :1.3.1.qualifier / 1.1.1.qualifier", result.getChildren()[0].getMessage());
	}
