 ...
 ******************************************************************************/
package org.polarsys.kitalpha.richtext.mde.tools.dialogs;
...
import org.polarsys.kitalpha.richtext.mde.tools.managers.LinkManager;
	...
	private void createBrowserButton(Composite composite) {
		...
		browseButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				if (linkType.equalsIgnoreCase(Constants.FILE_LABEL)){
