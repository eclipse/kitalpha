...
public interface MDERichTextWidget {
	...
	/**
	 * Evaluate Java script commands
	 * @param javascript
	 * @return
	 */
	Object evaluateJavascript(String javascript);
	 ...
	 *  </ul>
	 */
	boolean setItemState(String command, String state);
	...
	/**
	 * Add callback listener on custom handler item
	 * @param listener
	 */
	void addJavaCallbackListener(JavaCallbackListener listener);
	
	/**
	 * Remove callback listener on custom handler item
	 * @param listener
	 */
	void removeJavaCallbackListener(JavaCallbackListener listener);
