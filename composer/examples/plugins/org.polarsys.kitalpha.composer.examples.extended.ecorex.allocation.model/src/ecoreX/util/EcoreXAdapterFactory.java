...
public class EcoreXAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EcoreXSwitch<Adapter> modelSwitch =
		new EcoreXSwitch<Adapter>() {
			@Override
			public Adapter caseExtentedEClass(ExtentedEClass object) {
				return createExtentedEClassAdapter();
			}
			@Override
			public Adapter caseExtendedEPackage(ExtendedEPackage object) {
				return createExtendedEPackageAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecoreX.ExtentedEClass <em>Extented EClass</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecoreX.ExtendedEPackage <em>Extended EPackage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
