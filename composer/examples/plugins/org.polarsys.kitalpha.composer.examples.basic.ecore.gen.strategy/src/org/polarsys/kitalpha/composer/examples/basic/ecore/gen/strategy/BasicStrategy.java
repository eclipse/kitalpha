...
/**
 * This strategy creates a file with one type for each EClass of the Ecore model.
 * 
 * @author Yann Mortier
 */
public class BasicStrategy implements IStrategy {
    ...
    public Map<String, Parameter> getParameters() {
        Parameter author = new Parameter(AUTHOR_PARAM,AUTHOR_PARAM, "The author of the model");
     ...
     *      java.util.Map)
     */
    public EcoreRoot allocateModelElements(EObject modelRoot_p, Map<String, Parameter> strategyParams_p) {
     ...
     */
    public EcoreRoot allocateModelElements(EObject modelRoot_p, Map<String, Parameter> strategyParams_p, List<EObject> modelElementsToGenerate_p) {
    	EcoreRoot result = EcorebasicallocFactory.eINSTANCE.createEcoreRoot();
