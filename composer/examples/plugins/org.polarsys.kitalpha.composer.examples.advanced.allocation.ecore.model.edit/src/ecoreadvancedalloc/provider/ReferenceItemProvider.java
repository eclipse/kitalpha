...
/**
 * This is the item provider adapter for a {@link ecoreadvancedalloc.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHyperlinkRefPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcoreadvancedallocPackage.Literals.REFERENCE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Hyperlink Ref feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHyperlinkRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_hyperlinkRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_hyperlinkRef_feature", "_UI_Reference_type"),
				 EcoreadvancedallocPackage.Literals.REFERENCE__HYPERLINK_REF,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
