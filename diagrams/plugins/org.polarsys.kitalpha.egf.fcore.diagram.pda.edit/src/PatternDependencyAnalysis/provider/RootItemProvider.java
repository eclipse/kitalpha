...
/**
 * This is the item provider adapter for a {@link PatternDependencyAnalysis.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PatternDependencyAnalysisPackage.Literals.ROOT__PATTERNS);
			childrenFeatures.add(PatternDependencyAnalysisPackage.Literals.ROOT__SECTIONS_ANALYSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PatternDependencyAnalysisPackage.Literals.ROOT__PATTERNS,
				 PatternDependencyAnalysisFactory.eINSTANCE.createPatternAnalysis()));

		newChildDescriptors.add
			(createChildParameter
				(PatternDependencyAnalysisPackage.Literals.ROOT__SECTIONS_ANALYSES,
				 PatternDependencyAnalysisFactory.eINSTANCE.createSectionAnalysis()));
	}
