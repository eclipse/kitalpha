...
public class GlobalHeaderBuilder
		extends
	...
	protected final String TEXT_4 = NL
			...
			+ "\t\tfont-size:25px\">" + NL + "\t\tList of models" + NL
			+ "\t</h1>" + NL + "\t<div style=\"float:right; " + NL
			+ "\t\t position:relative; " + NL + "\t\t top:10px; " + NL
			+ "\t\t right:30px;\">" + NL + "\t\t <img style=\"height:45px;\" "
			+ NL + "\t\t\t  src=\"../img/logo.gif\" " + NL + "\t\t\t  alt=\"";
