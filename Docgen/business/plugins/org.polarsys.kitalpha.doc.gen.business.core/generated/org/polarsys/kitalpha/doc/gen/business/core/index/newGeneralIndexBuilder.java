...
public class newGeneralIndexBuilder extends org.polarsys.kitalpha.doc.gen.business.core.doccontent.ElementDocContent {
	protected static String nl;

	public static synchronized newGeneralIndexBuilder create(String lineSeparator) {
		nl = lineSeparator;
	...
	protected final String TEXT_4 = "<frameset rows=\"63,*,40\" frameborder=\"0\" framespacing=\"0\" border=\"0\">" + NL
			...
			+ "  <frameset cols=\"22%,*\" border=\"5\" frameborder=\"1\" framespacing=\"1\">" + NL + "  <frame src=\"modelindex.html\" name=\"modelsIndex\"/>" + NL + "  <frame name=\"content\"/>" + NL
