...
public class HeaderBuilder extends org.polarsys.kitalpha.doc.gen.business.core.doccontent.ElementDocContent {
  ...
  protected final String TEXT_4 = NL + "<body style=\"background-color:#5C74A2; " + NL
      ...
      + "\t  background-repeat:repeat-x;\">" + NL + "\t" + NL + "\t<h1 style=\"width:50%; " + NL + "\t\tfloat:left; "
      + NL + "\t\tcolor:#FFFFFF; " + NL + "\t\tmargin:15px; " + NL + "\t\tfont-family: Arial, sans-serif; " + NL
      + "\t\tfont-size:25px\">" + NL + "\t\t";
  protected final String TEXT_5 = NL + "\t</h1>" + NL + "\t<div style=\"float:right; " + NL + "\t\t position:relative; "
      + NL + "\t\t top:10px; " + NL + "\t\t right:30px;\">" + NL + "\t\t <img style=\"height:45px;\" " + NL
  ...
  protected void method_content(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
    ...
    stringBuffer.append(org.polarsys.kitalpha.doc.gen.business.core.util.DocGenHtmlUtil.getModelName(domain.get(0)));
