...
public class FooterBuilder extends org.polarsys.kitalpha.doc.gen.business.core.doccontent.ElementDocContent {
	...
	protected final String TEXT_1 = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Frameset//EN\"" + NL + "   \"http://www.w3.org/TR/html4/frameset.dtd\">" + NL + "<html>" + NL + "<head>" + NL + "<title>";
	protected final String TEXT_2 = "</title>" + NL + "</head>";
	protected final String TEXT_3 = "</html>";
	protected final String TEXT_4 = NL + "<body style=\"background-color:#DDE0E3; margin:0px; padding:0px;\">" + NL + "<p " + NL + "\tstyle=\"color:#000000; " + NL + "\ttext-align:center; " + NL + "\tmargin:0px; " + NL + "\tpadding:0px; " + NL + "\tmargin-top:5px; " + NL + "\tfont-family: Arial, sans-serif; " + NL + "\tfont-size:12px\">" + NL + "\t";
	protected final String TEXT_5 = NL + "</p>" + NL + "<p " + NL + "\tstyle=\"color:#000000; " + NL + "\ttext-align: right; " + NL + "\tmargin:0px; " + NL + "\tpadding:0px; " + NL + "\tmargin-top:5px; " + NL + "\tfont-family: Arial, sans-serif; " + NL + "\tfont-size:9px\">" + NL + "\t<span style=\"display:block;float:left\">Page generated: ";
	protected final String TEXT_6 = " </span>" + NL + "\tGenerated by Docgen html from the <a  href=\"https://www.polarsys.org/projects/polarsys.kitalpha\" target=\"_blank\"> Kitalpha </a> Project" + NL + "</p>" + NL + "</body>";
