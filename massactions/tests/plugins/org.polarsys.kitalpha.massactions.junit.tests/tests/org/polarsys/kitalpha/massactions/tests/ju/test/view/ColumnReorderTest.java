...
public class ColumnReorderTest {
    ...
    private void testColumnReorder(MAView view) {
        ...
        List<Integer> beforeIndexOrder = new ArrayList<>(columnReorderLayer.getColumnIndexOrder());
        ...
        List<Integer> afterIndexOrder = new ArrayList<>(columnReorderLayer.getColumnIndexOrder());
