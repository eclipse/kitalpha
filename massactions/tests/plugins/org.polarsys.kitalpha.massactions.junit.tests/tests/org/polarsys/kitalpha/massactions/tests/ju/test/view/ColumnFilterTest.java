...
public class ColumnFilterTest {
     ...
     * element of the same type as the existing ones is added to the view. And that ONLY THE COMMON filters are
    ...
    private void testColumnFilter(MAView view) {
        ...
        FilterRowDataProvider<EObject> filterRowDataProvider = filterHeaderLayer.getFilterRowDataLayer().getFilterRowDataProvider();

        // the internal representation of column filters
        Map<Integer, Object> beforeFilteredIndexToObject = Collections.emptyMap();
        Map<Integer, Object> afterFilteredIndexToObject;
