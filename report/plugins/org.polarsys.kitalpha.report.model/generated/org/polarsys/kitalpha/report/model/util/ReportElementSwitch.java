 ...
 * @generated
 */
public class ReportElementSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ReportElementPackage.LOG_ENTRY: {
				LogEntry logEntry = (LogEntry)theEObject;
				T result = caseLogEntry(logEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReportElementPackage.SEVERITY: {
				Severity severity = (Severity)theEObject;
				T result = caseSeverity(severity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReportElementPackage.REPORT_LIST: {
				ReportList reportList = (ReportList)theEObject;
				T result = caseReportList(reportList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Report List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Report List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReportList(ReportList object) {
		return null;
	}
